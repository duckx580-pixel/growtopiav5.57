            ...
            while (i < size) {
                ...
                if (StringsKt.equals(responseHeaders.name(i), "Sec-WebSocket-Extensions", true)) {
                    ...
                    while (i3 < strValue.length()) {
                        int i4 = i3;
                        int iDelimiterOffset$default = Util.delimiterOffset$default(strValue, AbstractJsonLexerKt.COMMA, i4, 0, 4, (Object) null);
                        ...
                        if (StringsKt.equals(strTrimSubstring, "permessage-deflate", true)) {
                            if (!z) {
                                ...
                                while (i5 < iDelimiterOffset$default) {
                                    int iDelimiterOffset2 = Util.delimiterOffset(strValue, ';', i5, iDelimiterOffset$default);
                                    int iDelimiterOffset3 = Util.delimiterOffset(strValue, nb.T, i5, iDelimiterOffset2);
                                    String strTrimSubstring2 = Util.trimSubstring(strValue, i5, iDelimiterOffset3);
