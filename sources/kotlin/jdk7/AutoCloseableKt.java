...
import androidx.documentfile.provider.DocumentsContractApi19$$ExternalSyntheticThrowIAE2;
...
public final class AutoCloseableKt {
    ...
    public static final void closeFinally(AutoCloseable autoCloseable, Throwable th) throws Exception {
        if (autoCloseable != null) {
            if (th == null) {
                DocumentsContractApi19$$ExternalSyntheticThrowIAE2.m(autoCloseable);
                return;
            }
            try {
                DocumentsContractApi19$$ExternalSyntheticThrowIAE2.m(autoCloseable);
