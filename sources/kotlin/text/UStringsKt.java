...
public final class UStringsKt {
    ...
    public static final String m4903toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m4905toStringolVBNx4(short s, int i) {
    ...
    public static final String m4904toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m4902toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m3685constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m3602boximpl(UByte.m3608constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m3685constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m3865boximpl(UShort.m3871constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM3685constructorimpl = UInt.m3685constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM3685constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM3685constructorimpl2 = UInt.m3685constructorimpl(i3 * iM3685constructorimpl);
            int iM3685constructorimpl3 = UInt.m3685constructorimpl(UInt.m3685constructorimpl(iDigitOf) + iM3685constructorimpl2);
            if (Integer.compareUnsigned(iM3685constructorimpl3, iM3685constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM3685constructorimpl3;
        }
        return UInt.m3679boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM3764constructorimpl = ULong.m3764constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM3764constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM3764constructorimpl2 = ULong.m3764constructorimpl(j * jM3764constructorimpl);
            long jM3764constructorimpl3 = ULong.m3764constructorimpl(ULong.m3764constructorimpl(((long) UInt.m3685constructorimpl(iDigitOf)) & 4294967295L) + jM3764constructorimpl2);
            if (Long.compareUnsigned(jM3764constructorimpl3, jM3764constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM3764constructorimpl3;
        }
        return ULong.m3758boximpl(j);
    }
}
