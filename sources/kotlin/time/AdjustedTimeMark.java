...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo4907minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m5053minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo4906elapsedNowUwyO8pc() {
        return Duration.m4951minusLRDsOJo(this.mark.mo4906elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo4909plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m4952plusLRDsOJo(this.adjustment, duration), null);
    }
}
