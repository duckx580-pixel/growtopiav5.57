...
final class MessageLiteToString {
    ...
    private static void reflectivePrintWithIndent(MessageLite messageLite, StringBuilder buffer, int indent) {
        ...
        if (messageLite instanceof GeneratedMessageLite.ExtendableMessage) {
            ...
            while (it.hasNext()) {
                ...
                printField(buffer, indent, v8.i.d + ((GeneratedMessageLite.ExtensionDescriptor) entry2.getKey()).getNumber() + v8.i.e, entry2.getValue());
            }
        }
    ...
    static void printField(StringBuilder buffer, int indent, String name, Object object) {
        ...
        if (object instanceof Map.Entry) {
            ...
            int i = indent + 2;
            printField(buffer, i, v8.h.W, entry.getKey());
