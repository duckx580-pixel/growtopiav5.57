...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM5107getOrNullimpl = ChannelResult.m5107getOrNullimpl(((SimpleActor) this).messageQueue.mo5097tryReceivePtdJZtk());
                        if (objM5107getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM5107getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo5092trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM5106exceptionOrNullimpl = ChannelResult.m5106exceptionOrNullimpl(obj);
            if (thM5106exceptionOrNullimpl != null) {
                throw thM5106exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m5112isSuccessimpl(obj)) {
