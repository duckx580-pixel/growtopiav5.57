...
public final class DataStoreImpl<T> implements DataStore<T> {
    ...
    static final class C01311 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01311(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01311> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C01321 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01321(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01321> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C01331 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01331(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01331> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C01341 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01341(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01341> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    static final class C01361 extends ContinuationImpl {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01361(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01361> continuation) {
            super(continuation);
            this.this$0 = dataStoreImpl;
        }
    ...
    */
    public final java.lang.Object incrementCollector(kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        /*
            r11 = this;
            boolean r0 = r12 instanceof androidx.datastore.core.DataStoreImpl.C01321
            if (r0 == 0) goto L14
            r0 = r12
            androidx.datastore.core.DataStoreImpl$incrementCollector$1 r0 = (androidx.datastore.core.DataStoreImpl.C01321) r0
            int r1 = r0.label
    ...
    */
    ...
    public Object updateData(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        ...
        return BuildersKt.withContext(new UpdatingDataContextElement(updatingDataContextElement, this), new C01402(this, function2, null), continuation);
    }
    ...
    static final class C01402 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C01402(DataStoreImpl<T> dataStoreImpl, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C01402> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C01402 c01402 = new C01402(this.this$0, this.$transform, continuation);
            c01402.L$0 = obj;
            return c01402;
        }
    ...
    static final class C01382 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super State<T>>, Object> {
        final /* synthetic */ boolean $requireLock;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01382(DataStoreImpl<T> dataStoreImpl, boolean z, Continuation<? super C01382> continuation) {
            super(2, continuation);
            this.this$0 = dataStoreImpl;
            this.$requireLock = z;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C01382(this.this$0, this.$requireLock, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L5d:
                ...
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C01382.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final Object readState(boolean z, Continuation<? super State<T>> continuation) {
        return BuildersKt.withContext(this.scope.getCoroutineContext(), new C01382(this, z, null), continuation);
    }
    ...
    */
    public final java.lang.Object readAndInitOrPropagateAndThrowFailure(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) throws java.lang.Throwable {
        /*
            r5 = this;
            boolean r0 = r6 instanceof androidx.datastore.core.DataStoreImpl.C01331
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.core.DataStoreImpl$readAndInitOrPropagateAndThrowFailure$1 r0 = (androidx.datastore.core.DataStoreImpl.C01331) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    */
    ...
    static final class C01353 extends SuspendLambda implements Function1<Continuation<? super Pair<? extends State<T>, ? extends Boolean>>, Object> {
        Object L$0;
        int label;
        final /* synthetic */ DataStoreImpl<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01353(DataStoreImpl<T> dataStoreImpl, Continuation<? super C01353> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01353(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Pair<? extends State<T>, Boolean>> continuation) {
            return ((C01353) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static final class C01392 extends SuspendLambda implements Function1<Continuation<? super T>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C01392(DataStoreImpl<T> dataStoreImpl, CoroutineContext coroutineContext, Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C01392> continuation) {
            super(1, continuation);
            this.this$0 = dataStoreImpl;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01392(this.this$0, this.$callerContext, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super T> continuation) {
            return ((C01392) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r9) throws androidx.datastore.core.CorruptionException {
            ...
            L76:
                return r9
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.DataStoreImpl.C01392.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public final Object transformAndWrite(Function2<? super T, ? super Continuation<? super T>, ? extends Object> function2, CoroutineContext coroutineContext, Continuation<? super T> continuation) {
        return getCoordinator().lock(new C01392(this, coroutineContext, function2, null), continuation);
    }
    ...
    */
    ...
    static final class C01373 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C01373(Ref.ObjectRef<T> objectRef, DataStoreImpl<T> dataStoreImpl, Ref.IntRef intRef, Continuation<? super C01373> continuation) {
            super(1, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return new C01373(this.$newData, this.this$0, this.$version, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C01373) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }
