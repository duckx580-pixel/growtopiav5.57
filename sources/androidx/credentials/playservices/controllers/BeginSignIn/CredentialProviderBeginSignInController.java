...
public final class CredentialProviderBeginSignInController extends CredentialProviderController<GetCredentialRequest, BeginSignInRequest, SignInCredential, GetCredentialResponse, GetCredentialException> {
    ...
    @JvmStatic
    public static final CredentialProviderBeginSignInController getInstance(Activity activity) {
        return INSTANCE.getInstance(activity);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Type inference failed for: r0v2, types: [androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$resultReceiver$1] */
    public CredentialProviderBeginSignInController(Activity activity) {
        super(activity);
    ...
    /* JADX WARN: Type inference failed for: r6v1, types: [T, androidx.credentials.exceptions.GetCredentialUnknownException] */
    /* JADX WARN: Type inference failed for: r6v6, types: [T, androidx.credentials.exceptions.GetCredentialInterruptedException] */
    ...
    public final void handleResponse$credentials_play_services_auth_release(int uniqueRequestCode, int resultCode, Intent data) {
        ...
        if (CredentialProviderController.maybeReportErrorResultCodeGet(resultCode, TAG2, new Function2<CancellationSignal, Function0<? extends Unit>, Unit>() { // from class: androidx.credentials.playservices.controllers.BeginSignIn.CredentialProviderBeginSignInController$handleResponse$1
        ...
        try {
            SignInCredential signInCredentialFromIntent = Identity.getSignInClient(this.activity).getSignInCredentialFromIntent(data);
            Intrinsics.checkNotNullExpressionValue(signInCredentialFromIntent, "getSignInClient(activity…redentialFromIntent(data)");
    ...
    public BeginSignInRequest convertRequestToPlayServices(GetCredentialRequest request) {
        Intrinsics.checkNotNullParameter(request, "request");
        return BeginSignInControllerUtility.INSTANCE.constructBeginSignInRequest$credentials_play_services_auth_release(request);
    }
    ...
    public GetCredentialResponse convertResponseToCredentialManager(SignInCredential response) throws GetCredentialUnknownException {
        ...
        if (response.getPassword() != null) {
            ...
            try {
                ...
                throw new GetCredentialUnknownException(th.getMessage());
            }
        } else {
    ...
    private final GoogleIdTokenCredential createGoogleIdCredential(SignInCredential response) {
        ...
        if (response.getProfilePictureUri() != null) {
            idToken.setProfilePictureUri(String.valueOf(response.getProfilePictureUri()));
        }
        return idToken.build();
    }

    /* JADX INFO: compiled from: CredentialProviderBeginSignInController.kt */
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\nH\u0007R\u0016\u0010\u0003\u001a\n \u0005*\u0004\u0018\u00010\u00040\u0004X\u0082\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000b"}, d2 = {"Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController$Companion;", "", "()V", "TAG", "", "kotlin.jvm.PlatformType", "controller", "Landroidx/credentials/playservices/controllers/BeginSignIn/CredentialProviderBeginSignInController;", "getInstance", "activity", "Landroid/app/Activity;", "credentials-play-services-auth_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        ...
        @JvmStatic
        public final CredentialProviderBeginSignInController getInstance(Activity activity) {
            Intrinsics.checkNotNullParameter(activity, "activity");
            if (CredentialProviderBeginSignInController.controller == null) {
                CredentialProviderBeginSignInController.controller = new CredentialProviderBeginSignInController(activity);
            }
