...
public class C03276y<E> extends AbstractC03266x<E>.IteratorImpl implements ListIterator<E> {
    public static byte[] A01;
    public final /* synthetic */ AbstractC03266x<E> A00;
    ...
    public C03276y(AbstractC03266x abstractC03266x, int i) {
        super(abstractC03266x);
        this.A00 = abstractC03266x;
        AbstractC03266x.A02.A04(i, this.A00.size());
        A05(i);
    }
    ...
    public final E previous() {
        if (hasPrevious()) {
            AbstractC03266x<E> abstractC03266x = this.A00;
            A05(getA00() - 1);
            return abstractC03266x.get(getA00());
        }
