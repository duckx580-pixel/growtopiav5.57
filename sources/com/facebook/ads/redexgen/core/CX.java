...
public abstract class CX {
    public static CW A00(int i, long[] jArr, int[] iArr, long j) {
        int chunkSamplesRemaining = 8192 / i;
        int iA04 = 0;
        for (int i2 : iArr) {
            iA04 += IK.A04(i2, chunkSamplesRemaining);
        }
        ...
        return new CW(jArr2, iArr2, originalSampleIndex, timestamps, flags, j * ((long) i3));
    }
}
