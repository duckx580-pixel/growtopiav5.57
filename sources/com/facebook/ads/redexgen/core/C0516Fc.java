...
public final class C0516Fc extends AbstractC1147bi {
    ...
    public C0516Fc(C1127bO c1127bO, String str) {
        super(c1127bO.A0B, str, A00(c1127bO));
        this.A01 = c1127bO;
    }

    public static C1126bN A00(C1127bO c1127bO) {
        return new C1126bN(c1127bO);
    }
    ...
    public final void A09() {
        this.A00 = new C1137bY(this.A01, this, A04());
    ...
    public final void A0D(Ad ad, String str, AdExperienceType adExperienceType, boolean z) {
        ...
        this.A01.A08 = z;
        if (AbstractC0601Ip.A07(this.A02) && AbstractC0601Ip.A09(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final void A0E(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, C2K.A00(new Bundle(), rewardData));
    ...
    public final boolean A0F() {
        ...
        return this.A01.A01 > 0 && C0678Lu.A00() > this.A01.A01;
    }
    ...
    public final boolean A0H(Ad ad, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int iA00 = ((AnonymousClass61) rewardedVideoShowAdConfig).A00();
        long jA01 = ((AnonymousClass61) rewardedVideoShowAdConfig).A01();
        if (super.A00.A60()) {
            return false;
        }
        this.A01.A02(ad);
