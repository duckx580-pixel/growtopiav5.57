...
public final class P9 extends RelativeLayout {
    ...
    public P9(C1036Zs c1036Zs, View view) {
        super(c1036Zs);
        this.A00 = view;
        this.A01 = new OV(c1036Zs);
        M3.A0K(this.A01);
    }
     ...
     */
    public final void A01(C0736Oa c0736Oa, boolean z) {
        ...
        if (c0736Oa != null) {
            if (z) {
                ...
                c0736Oa.setAlignment(3);
                layoutParams2.setMargins(AbstractC0744Oi.A07 / 2, AbstractC0744Oi.A07 / 2, AbstractC0744Oi.A07 / 2, AbstractC0744Oi.A07 / 2);
                linearLayout.addView(c0736Oa, layoutParams2);
                ...
                insideLayoutParams.setMargins(0, AbstractC0744Oi.A07, 0, 0);
                c0736Oa.setAlignment(17);
                addView(c0736Oa, insideLayoutParams);
            }
        }
