...
public final class O5 extends FrameLayout {
    ...
    public O5(C1036Zs c1036Zs) {
        super(c1036Zs);
        this.A03 = new ImageView(c1036Zs);
        this.A02 = new ImageView(c1036Zs);
        A00();
    }

    public O5(C1036Zs c1036Zs, AttributeSet attributeSet) {
        super(c1036Zs, attributeSet);
        this.A03 = new ImageView(c1036Zs, attributeSet);
        this.A02 = new ImageView(c1036Zs, attributeSet);
        A00();
    }

    public O5(C1036Zs c1036Zs, AttributeSet attributeSet, int i) {
        super(c1036Zs, attributeSet, i);
        this.A03 = new ImageView(c1036Zs, attributeSet, i);
        this.A02 = new ImageView(c1036Zs, attributeSet, i);
        A00();
    }

    public O5(C1036Zs c1036Zs, AttributeSet attributeSet, int i, int i2) {
        super(c1036Zs, attributeSet, i, i2);
        this.A03 = new ImageView(c1036Zs, attributeSet, i, i2);
        this.A02 = new ImageView(c1036Zs, attributeSet, i, i2);
        A00();
    }
