...
public final class AnonymousClass88 {
    ...
    public static int A00(String str, int i, C7j c7j) {
        if ((A01(462, 7, 5).equals(str) && C8E.A20 == i) || A01(422, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
    ...
    public static void A05(C7j c7j, int i, int i2) {
        c7j.A07().AA0(A01(427, 10, 35), C8E.A2Z, new C8F(A01(338, 33, 12) + i, A01(87, 9, 54) + i2));
    }

    @Deprecated
    public static void A06(C7j c7j, String str, int i, C8F c8f) {
        if (c7j == null) {
            A0F(new RuntimeException(A01(48, 39, 37)));
            return;
        }
        AbstractC03367i.A01(c7j.A01());
        if (A02 && c8f.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 81) + str + A01(31, 16, 108) + i, c8f));
        }
        try {
            if (A0J(c7j, str, i, Math.random(), c8f)) {
                A09(c7j, str, i, c8f);
            }
        } catch (Throwable th) {
            if (A05[7].length() == 7) {
    ...
    @Deprecated
    public static void A07(C7j c7j, String str, int i, C8F c8f) {
        try {
            c8f.A05(2);
            c8f.A0A(false);
            c8f.A06(1);
    ...
    @Deprecated
    public static void A08(C7j c7j, String str, int i, C8F c8f) {
        try {
            c8f.A05(2);
            c8f.A08(false);
            A06(c7j, str, i, c8f);
    ...
    public static void A09(C7j c7j, String str, int i, C8F c8f) {
        synchronized (AnonymousClass88.class) {
            if (!A03) {
                int iA01 = Io.A01(c7j);
                int threshold = A09.getAndIncrement();
                if (threshold < iA01 - 1) {
                    A07.add(new AnonymousClass89(str, i, c8f));
                } else if (A09.get() == iA01) {
                    A07.add(new AnonymousClass89(A01(427, 10, 35), C8E.A2W, new C8F(A01(IronSourceConstants.USING_CACHE_FOR_INIT_EVENT, 42, 70) + str + A01(47, 1, 91) + i)));
                }
            } else {
    ...
    public static void A0A(C7j c7j, String str, int i, C8F c8f, boolean z) {
        ...
        if (z3 || z2) {
            ...
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 114) + str + strA012 + i, c8f);
            } else {
                Log.i(strA01, A01(306, 32, 102) + str + strA012 + i + A01(19, 12, 98) + c8f.getMessage() + A01(0, 19, 12) + c8f.A03());
            }
        }
        C1027Zj c1027Zj = new C1027Zj(c7j, str, i, c8f, anonymousClass87);
        if (z) {
            A01.execute(c1027Zj);
        } else {
            c1027Zj.run();
    ...
    public static void A0C(C1035Zr c1035Zr, AnonymousClass87 anonymousClass87, AnonymousClass86 anonymousClass86, boolean z) {
        ...
        synchronized (AnonymousClass88.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1028Zk(c1035Zr));
            }
        }
    }
    ...
    public static boolean A0I(C7j c7j) {
        ...
        double funnelEventLogProbability = 1.0d / ((double) Io.A0A(c7j));
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.core.C7j r13, java.lang.String r14, int r15, double r16, com.facebook.ads.redexgen.core.C8F r18) {
        /*
            Method dump skipped, instruction units count: 633
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AnonymousClass88.A0J(com.facebook.ads.redexgen.X.7j, java.lang.String, int, double, com.facebook.ads.redexgen.X.8F):boolean");
    }

    public static boolean A0K(C7j c7j, String str, int i, C8F c8f) {
        if (!Io.A0P(c7j)) {
            return true;
        }
