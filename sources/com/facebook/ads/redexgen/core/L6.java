...
public final class L6 {
    ...
    public static int A00(C1036Zs c1036Zs, int i) {
        return KJ.A00(c1036Zs).getInt(A01(0, 21, 52), i);
    }

    public static String A02(C1036Zs c1036Zs, String str) {
        int iA00 = A00(c1036Zs, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1036Zs c1036Zs, String str, String str2) {
        if (c1036Zs == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1036Zs, str);
    ...
    public final RewardedVideoAd A07(C1036Zs c1036Zs, String str, String str2) {
        if (c1036Zs == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1036Zs, str);
    ...
    public final void A08(C1036Zs c1036Zs, boolean z) {
        int i = 0;
        String strA01 = A01(0, 21, 52);
        if (!z) {
            int lastNonChainedAds = KJ.A00(c1036Zs).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        KJ.A00(c1036Zs).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C1036Zs c1036Zs, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1036Zs, i - 1);
