...
public final class YC implements InterfaceC0446Bx {
    ...
    public final int AEk(InterfaceC0447By interfaceC0447By, C4 c4) throws InterruptedException, IOException {
        int i = interfaceC0447By.read(this.A03.A00, 0, 200);
        if (i == -1) {
            return -1;
        }
        this.A03.A0Y(0);
    ...
    public final boolean AGs(InterfaceC0447By interfaceC0447By) throws InterruptedException, IOException {
        ...
        interfaceC0447By.A3s(startPosition);
        int syncBytes = startPosition;
        int validFramesCount = 0;
        int i = 0;
        while (true) {
            interfaceC0447By.AEO(i4.A00, 0, 2);
            i4.A0Y(0);
            ...
            if (headerPosition != 65520) {
                ...
                interfaceC0447By.A3s(syncBytes);
            } else {
                i++;
                ...
                interfaceC0447By.A3s(headerPosition3 - 6);
