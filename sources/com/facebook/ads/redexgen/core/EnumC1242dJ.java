...
public enum EnumC1242dJ {
    ...
    public static EnumC1242dJ[] valuesCustom() {
        EnumC1242dJ[] enumC1242dJArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC1242dJ[]) enumC1242dJArrValuesCustom.clone();
    }
