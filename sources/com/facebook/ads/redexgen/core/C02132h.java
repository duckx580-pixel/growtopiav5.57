...
public final class C02132h extends Drawable {
    ...
    public C02132h(ColorStateList colorStateList, float f) {
        this.A01 = f;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = C02152j.A01(this.A00, this.A01, this.A07);
            float vInset = C02152j.A00(this.A00, this.A01, this.A07);
