...
public final class Q2 extends RelativeLayout {
    ...
    public Q2(C1036Zs c1036Zs, C1Z c1z, C1M c1m, ViewOnClickListenerC0900Ui viewOnClickListenerC0900Ui, String str, View.OnClickListener onClickListener) {
        super(c1036Zs);
        this.A04 = c1036Zs;
        this.A03 = c1z;
        this.A02 = c1m;
        ...
        this.A06 = new C0736Oa(this.A04, C1O.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC0737Ob.A00(this.A04, this, this.A03.A01());
        ...
        new AsyncTaskC0905Un(this.A05, this.A04).A04().A07(this.A03.A01());
