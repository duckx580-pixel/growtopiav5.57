...
public final class C5A extends DD {
    ...
    public int A02;
    public int A03;
    public List<C0530Fs> A05;
    public List<C0530Fs> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final I4 A0A = new I4();
    public final ArrayList<C0537Fz> A0B = new ArrayList<>();
    public C0537Fz A04 = new C0537Fz(0, 4);
    ...
    static {
        ...
        A0J = new int[]{195, 227, 205, 204, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, Sdk.SDKError.Reason.STALE_CACHED_RESPONSE_VALUE, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    }
    ...
    private List<C0530Fs> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < this.A0B.size(); i++) {
            C0530Fs c0530FsA05 = this.A0B.get(i).A05();
            if (c0530FsA05 != null) {
                arrayList.add(c0530FsA05);
            }
        }
        return arrayList;
    }
            ...
            if (i != iA04) {
                ...
                if (iCharAt2 == row4) {
                    ...
                    if (i2 != 1 && !this.A04.A0F()) {
                        this.A04 = new C0537Fz(this.A02, this.A03);
                        this.A0B.add(this.A04);
                    }
                    this.A04.A0C(i);
                }
            }
            boolean isCursor = (b2 & Ascii.DLE) == 16;
            int row5 = b2 & 1;
            boolean z = row5 == 1;
            int row6 = b2 >> 1;
            int i3 = row6 & 7;
            C0537Fz c0537Fz = this.A04;
            int row7 = isCursor ? 8 : i3;
            c0537Fz.A0E(row7, z);
            if (isCursor) {
                C0537Fz c0537Fz2 = this.A04;
                int row8 = A0F[i3];
                c0537Fz2.A0B(row8);
                return;
            }
    ...
    public final /* bridge */ /* synthetic */ DO A5Q() throws C0532Fu {
        return super.A5Q();
    }

    @Override // com.facebook.ads.redexgen.core.DD
    /* JADX INFO: renamed from: A0M */
    public final /* bridge */ /* synthetic */ DM A5R() throws C0532Fu {
        return super.A5R();
    }
    ...
    public final /* bridge */ /* synthetic */ void AEj(DO r1) throws C0532Fu {
        super.AEj(r1);
    }
