...
public abstract class AbstractC1231d4 {
    ...
    public static final <T> void A02(Appendable appendable, T t, InterfaceC0565Hd<? super T, ? extends CharSequence> interfaceC0565Hd) throws IOException {
        C1234d7.A07(appendable, A00(0, 6, 22));
        if (interfaceC0565Hd != null) {
            appendable.append(interfaceC0565Hd.A9K(t));
            return;
        }
