...
public abstract class MA {
    public static Bitmap A00(C1036Zs c1036Zs, Bitmap bitmap, int i) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c1036Zs);
    ...
    public static Bitmap A01(C1036Zs c1036Zs, Bitmap bitmap, int i, int i2) {
        ...
        try {
            Bitmap bitmapA00 = A00(c1036Zs, bitmapCreateBitmap, i);
            if (i2 != 1) {
            ...
            return new C0923Vf().A02(bitmapCreateBitmap, i);
        }
    }
}
