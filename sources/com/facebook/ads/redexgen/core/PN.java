...
public abstract class PN {
    public static BP A00(final C0748Om c0748Om, int i, final String str, final TV tv) {
        if (i == 1) {
            return new BP(c0748Om, str, tv) { // from class: com.facebook.ads.redexgen.X.3Q
                ...
                public final void A1A(C1036Zs c1036Zs) {
                    C0736Oa titleDescContainer = getTitleDescContainer();
        ...
        return new BP(c0748Om, str, tv) { // from class: com.facebook.ads.redexgen.X.3b
            ...
            @Override // com.facebook.ads.redexgen.core.BP, com.facebook.ads.redexgen.core.AbstractC0744Oi
