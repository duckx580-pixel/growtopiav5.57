...
public final class C0736Oa extends LinearLayout {
    ...
    public C0736Oa(C1036Zs c1036Zs, C1O c1o, boolean z, int i, int i2, int i3) {
        super(c1036Zs);
        setOrientation(1);
        this.A02 = new TextView(c1036Zs);
        M3.A0Y(this.A02, true, i);
        this.A02.setEllipsize(TextUtils.TruncateAt.END);
        this.A02.setLineSpacing(A08, 1.0f);
        this.A01 = new TextView(c1036Zs);
        this.A00 = new TextView(c1036Zs);
        M3.A0Y(this.A00, false, i2);
        this.A00.setEllipsize(TextUtils.TruncateAt.END);
        this.A00.setLineSpacing(A08, 1.0f);
        this.A03 = C0599Im.A12(c1036Zs);
        int i4 = this.A03 ? -2 : -1;
    ...
    public C0736Oa(C1036Zs c1036Zs, C1O c1o, boolean z, boolean z2, boolean z3) {
        int i = z2 ? 18 : 22;
        int i2 = z2 ? 14 : 16;
        int i3 = A07;
        this(c1036Zs, c1o, z, i, i2, z3 ? i3 / 2 : i3);
    }

    public final void A02(C1O c1o, boolean z) {
    ...
    public void setCTAClickListener(ViewOnClickListenerC0900Ui viewOnClickListenerC0900Ui) {
        ViewOnClickListenerC0740Oe viewOnClickListenerC0740OeA03 = AbstractC0741Of.A03(viewOnClickListenerC0900Ui, A00(0, 9, 20));
        this.A02.setOnClickListener(viewOnClickListenerC0740OeA03);
        this.A00.setOnClickListener(viewOnClickListenerC0740OeA03);
        this.A01.setOnClickListener(viewOnClickListenerC0740OeA03);
    }
