...
public final class CI extends VY implements View.OnClickListener, View.OnTouchListener {
    ...
    public CI(C5Q c5q, C1036Zs c1036Zs, J7 j7, MR mr, String str, int i) {
        super(c5q, c1036Zs, j7, mr);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        ...
        this.A06 = (InputMethodManager) c1036Zs.getSystemService(A05(112, 12, 70));
        this.A04 = i;
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            ...
            super.A07.A0E(EnumC0809Qv.A04.A03(), null);
        }
    }
    ...
    public final InterfaceC0728Ns A0E() {
        return new C0920Vc(this);
    }
    ...
    public final void A0H(String str) {
        if (this.A04 > 0 && !this.A03) {
            ...
            if (this.A02 != null) {
                this.A02.A04(JE.A0J, mapA05);
            }
            A07();
            this.A09.AA9(super.A04, mapA05);
            if (C0599Im.A2J(super.A08)) {
