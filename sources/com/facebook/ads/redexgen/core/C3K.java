...
public final class C3K<T extends Enum<T>> extends AbstractC03266x<T> implements InterfaceC0566He<T>, Serializable {
    ...
    public C3K(T[] tArr) {
        C1234d7.A07(tArr, A03(7, 7, 113));
        this.A00 = tArr;
    }

    private final int A00(T t) {
        C1234d7.A07(t, A03(0, 7, 111));
        int iOrdinal = t.ordinal();
        if (((Enum) C3M.A00(this.A00, iOrdinal)) == t) {
            return iOrdinal;
        }
        return -1;
    }
    ...
    public final T get(int i) {
        AbstractC03266x.A02.A03(i, this.A00.length);
        return this.A00[i];
    }

    private final boolean A05(T t) {
        C1234d7.A07(t, A03(0, 7, 111));
        Enum target = (Enum) C3M.A00(this.A00, t.ordinal());
        return target == t;
    }
