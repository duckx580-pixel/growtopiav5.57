...
public final class C02965o implements NativeAdsManagerApi {
    ...
    public C02965o(Context context, String str, int i) {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC0620Jl enumC0620Jl = EnumC0620Jl.A06;
        int i = this.A06;
        C1153bo c1153bo = this.A02;
        this.A02 = new C1153bo(this.A07, this.A08, enumC0620Jl, null, i);
        if (this.A05) {
            this.A02.A06();
        }
        this.A02.A09(this.A03);
        this.A02.A08(new C1059aF(this, this.A07, mediaCacheFlag));
        this.A02.A07();
    }
