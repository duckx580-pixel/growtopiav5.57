...
import com.facebook.ads.redexgen.core.AbstractC03718x;
import com.facebook.ads.redexgen.core.C03698v;
...
public final class C03708w<T extends AbstractC03718x, E extends C03698v> {
    ...
    private void A00(E e) {
        ...
        while (it.hasNext()) {
            AbstractC03718x abstractC03718x = (AbstractC03718x) ((WeakReference) it.next()).get();
            if (abstractC03718x != null && abstractC03718x.A00(e)) {
                abstractC03718x.A03(e);
            }
        }
    }
    ...
    */
    private void A01(java.util.List<java.lang.ref.WeakReference<T>> r5) {
        ...
        L2d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C03708w.A01(java.util.List):void");
    }
