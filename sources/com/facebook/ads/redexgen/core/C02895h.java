...
public final class C02895h implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0827Rn A0C = new FB(this);
    public final AbstractC0843Sd A0B = new FA(this);
    public final R1 A0E = new F3(this);
    public final AbstractC0849Sj A09 = new Es(this);
    public final AbstractC0793Qf A0F = new Em(this);
    public final AbstractC0847Sh A0A = new C0508El(this);
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1036Zs c1036ZsA11 = ((W7) nativeAd.getInternalNativeAd()).A11();
        C1036Zs adObjectContext = this.A03;
        adObjectContext.A0K(c1036ZsA11);
        C02925k c02925k = (C02925k) nativeAd.getNativeAdApi();
        this.A05.setClientToken(W7.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c02925k.A01());
        this.A05.setVideoURI(c02925k.A02());
        C1195cU c1195cUA0y = W7.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (c1195cUA0y != null) {
            this.A05.setVideoProgressReportIntervalMs(c1195cUA0y.A0B());
        }
        this.A05.setVideoCTA(nativeAd.getAdCallToAction());
        this.A05.setNativeAd(nativeAd);
        this.A01 = c02925k.getVideoAutoplayBehavior();
        if (this.A04 != null) {
    ...
    public final void A07(InterfaceC0688Me interfaceC0688Me) {
        this.A05.setListener(interfaceC0688Me);
    }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0b(AbstractC0683Lz.A00(videoStartReason), 3);
        }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC0821Rh.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1036Zs) {
            c1036ZsA03 = (C1036Zs) context;
        } else {
            c1036ZsA03 = C02835b.A03(context);
        }
        this.A03 = c1036ZsA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C0443Bu(c1036ZsA03);
                break;
            case 1:
                this.A05 = new C0443Bu(c1036ZsA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C0443Bu(c1036ZsA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C0443Bu(c1036ZsA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0b(AbstractC0683Lz.A00(videoStartReason), 2);
    }
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC0821Rh.A06) {
            return false;
        }
