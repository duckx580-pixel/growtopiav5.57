...
public final class C0795Qh extends LinearLayout {
    public static final int A00 = (int) (LP.A02 * 32.0f);
    public static final int A01 = (int) (LP.A02 * 8.0f);

    public C0795Qh(C1036Zs c1036Zs, NativeAd nativeAd, JW jw, OU ou, AdOptionsView adOptionsView) {
        super(c1036Zs);
        setOrientation(0);
        ...
        TextView sponsoredTextView = new TextView(c1036Zs);
