...
public abstract class OL extends Button {
    ...
    public OL(C1036Zs c1036Zs, C1O c1o) {
        super(c1036Zs);
        this.A03 = false;
        this.A01 = 0;
        this.A00 = 0;
        this.A04 = true;
        this.A05 = false;
        this.A08 = new C0899Uh(this);
        this.A09 = new C0898Ug(this);
        this.A02 = c1o;
        this.A07 = C0599Im.A05(c1036Zs);
        this.A06 = C0599Im.A00(c1036Zs);
    ...
    private void A04() {
        ...
        if (C0599Im.A2W(getContext()) && Build.VERSION.SDK_INT >= 16) {
