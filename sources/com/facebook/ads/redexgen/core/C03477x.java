...
public final class C03477x {
    ...
    public C03477x(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C03477x(String[] strArr, Integer num, Integer num2) {
    ...
    public static C03477x A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                return new C03477x(linkedHashSet, numValueOf, numValueOf2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C03477x)) {
            return false;
        }
        C03477x c03477x = (C03477x) obj;
        if (this.A00 == c03477x.A00 || (this.A00 != null && this.A00.equals(c03477x.A00))) {
            return (this.A01 == c03477x.A01 || (this.A01 != null && this.A01.equals(c03477x.A01))) && this.A03.equals(c03477x.A03);
        }
        return false;
    }
