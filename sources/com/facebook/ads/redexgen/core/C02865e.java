...
public final class C02865e implements InterstitialAdApi, Repairable {
    public static byte[] A04;
    public final InterstitialAd A00;
    public final C1136bX A01;
    public final C0517Fd A02;
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC0629Ju.A05(A00(129, 8, 122), A00(65, 30, 111), A00(16, 8, 42));
        if (str == null) {
            this.A03.A0E().A3B();
        } else {
            this.A03.A0E().A3A();
    ...
    public final void destroy() {
        AbstractC0629Ju.A05(A00(122, 7, 21), A00(40, 25, 105), A00(8, 8, 56));
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C02875f) interstitialLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th) {
        if (this.A01.A6I() != null) {
            this.A01.A6I().onError(this.A00, new AdError(2001, A00(24, 16, 63) + AbstractC0669Ll.A03(this.A03, th)));
        }
    }
    ...
    public final boolean show() {
        AbstractC0629Ju.A05(A00(137, 4, 11), A00(95, 27, 100), A00(0, 8, 21));
        this.A03.A0E().A3K();
        boolean zA0H = this.A02.A0H(this.A00, new C02885g());
