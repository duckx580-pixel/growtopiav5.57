...
public final class ViewOnSystemUiVisibilityChangeListenerC0674Lq implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC0673Lp A02 = EnumC0673Lp.A02;
    public final Runnable A04 = new C0926Vi(this);

    public ViewOnSystemUiVisibilityChangeListenerC0674Lq(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z) {
        if (EnumC0673Lp.A02.equals(this.A02)) {
            return;
        }
        int i = 3840;
        if (!z) {
    ...
    public final void A05(EnumC0673Lp enumC0673Lp) {
        this.A02 = enumC0673Lp;
        switch (this.A02) {
            case A03:
