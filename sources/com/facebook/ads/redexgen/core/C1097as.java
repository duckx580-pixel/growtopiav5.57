...
public class C1097as extends AnonymousClass51 {
    ...
    private final int A03(View view, int i) {
        ...
        if (abstractC02714oA08 == null || !abstractC02714oA08.A21()) {
            return 0;
        }
        C02724p c02724p = (C02724p) view.getLayoutParams();
        return A0N(abstractC02714oA08.A0o(view) - c02724p.topMargin, abstractC02714oA08.A0j(view) + c02724p.bottomMargin, abstractC02714oA08.A0g(), abstractC02714oA08.A0X() - abstractC02714oA08.A0d(), i);
    }
    ...
    public int A0O(View view, int i) {
        AbstractC02714o abstractC02714oA08 = A08();
        if (abstractC02714oA08 == null || !abstractC02714oA08.A20()) {
            return 0;
        }
        C02724p c02724p = (C02724p) view.getLayoutParams();
        return A0N(abstractC02714oA08.A0k(view) - c02724p.leftMargin, abstractC02714oA08.A0n(view) + c02724p.rightMargin, abstractC02714oA08.A0e(), abstractC02714oA08.A0h() - abstractC02714oA08.A0f(), i);
    }
    ...
    public C1097as(Context context) {
    ...
    private final void A07(C02814z c02814z) {
        ...
        c02814z.A04(i, i2, time2, this.A05);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass51
    public final void A0H(int i, int i2, AnonymousClass53 anonymousClass53, C02814z c02814z) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass51
    public void A0I(View view, AnonymousClass53 anonymousClass53, C02814z c02814z) {
        ...
        if (time > 0) {
            int distance = -iA0O;
            int dy2 = -iA03;
            c02814z.A04(distance, dy2, time, this.A04);
        }
    }
    ...
    public PointF A0P(int i) {
        ...
        if (objA08 instanceof AnonymousClass50) {
            return ((AnonymousClass50) objA08).A4k(i);
        }
