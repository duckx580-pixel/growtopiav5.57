...
public class C1155bq implements AnonymousClass14 {
    ...
    public final /* synthetic */ C0521Fh A04;
    ...
    public C1155bq(C0521Fh c0521Fh, Runnable runnable, long j, C8U c8u) {
        this.A04 = c0521Fh;
        this.A06 = runnable;
        this.A03 = j;
        this.A05 = c8u;
    ...
    public final void ACn(C1195cU c1195cU) {
        if (!this.A00) {
            this.A00 = true;
            String[] strArr = A08;
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void ACo(C1195cU c1195cU) {
        if (c1195cU != this.A04.A00) {
            return;
        }
        Handler handlerA0G = this.A04.A0G();
        ...
        this.A04.A01 = c1195cU;
        this.A04.A07.A0F(c1195cU);
        if (!this.A02) {
            this.A02 = true;
            ...
            this.A04.A05(this.A05.A03(C8Y.A04), mapA01);
        }
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void ACp(C1195cU c1195cU) {
        if (!this.A01) {
            this.A01 = true;
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void ACr(C1195cU c1195cU, C0616Jg c0616Jg) {
        if (c1195cU != this.A04.A00) {
            return;
        }
        this.A04.A0G().removeCallbacks(this.A06);
        this.A04.A0P(c1195cU);
        if (!this.A02) {
            this.A02 = true;
            Map mapA01 = this.A04.A01(this.A03);
            mapA01.put(A00(0, 5, 14), String.valueOf(c0616Jg.A03().getErrorCode()));
            mapA01.put(A00(5, 3, 72), String.valueOf(c0616Jg.A04()));
            this.A04.A05(this.A05.A03(C8Y.A04), mapA01);
        }
        this.A04.ABs(c0616Jg);
    }
}
