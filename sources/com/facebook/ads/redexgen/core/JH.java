...
public abstract class JH {
    ...
    public static void A05(C1036Zs c1036Zs, String str, long j) {
        J7 adEventManager = c1036Zs.A09();
        JF jf = new JF(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), C0678Lu.A06(j));
        map.put(A00(12, 12, 71), C0678Lu.A04(j));
        jf.A04(JE.A0D, map);
    }

    public static void A06(C1036Zs c1036Zs, JSONObject jSONObject, long j, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1036Zs, jSONObjectOptJSONObject, A02(c1036Zs, jSONArrayOptJSONArray), j, null);
            return;
        }
        ...
        A07(c1036Zs, jSONObjectOptJSONObject, A03.get(str), j, str);
    }

    public static void A07(C1036Zs c1036Zs, JSONObject jSONObject, List<String> list, long j, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1036Zs, clientToken, j);
        }
    }
