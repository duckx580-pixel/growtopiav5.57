...
public final class EZ implements InterfaceC0992Ya {
    ...
    public static void A02() {
        ...
        A03 = new byte[]{48, 60, 83, 71, 87, 76, 37, 97, 100, 113, 100, 37, 118, 108, 127, 96, 37, 104, 108, 118, 104, 100, 113, 102, 109, Utf8.REPLACEMENT_BYTE, 37, Ascii.SUB, 46, 62, 37, Ascii.US, 41, 41, 39, 41, 62};
    }
    ...
    public static EZ A00(long j, long j2, C3 c3, I4 i4) {
        int iA0E;
        long j3 = j2;
        i4.A0Z(10);
        ...
        long jA0F = IK.A0F(numFrames, ((long) (sampleRate >= 32000 ? 1152 : 576)) * 1000000, sampleRate);
        int iA0I = i4.A0I();
    ...
    public final C5 A8H(long j) {
        int iA0B = IK.A0B(this.A02, j, true, true);
        C7 c7 = new C7(this.A02[iA0B], this.A01[iA0B]);
        if (c7.A01 < j) {
            ...
            if (iA0B != tableIndex - 1) {
                ...
                C7 nextSeekPoint = new C7(j2, this.A01[tableIndex3]);
    ...
    public final long A8W(long j) {
        return this.A02[IK.A0B(this.A01, j, true, true)];
    }
