...
public abstract class AbstractC02021w {
    ...
    public static AdSettings.IntegrationErrorMode A00(C1036Zs c1036Zs) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c1036Zs)) {
    ...
    public static boolean A03(C1036Zs c1036Zs) {
        return (c1036Zs.getApplicationInfo().flags & 2) != 0;
    }
}
