...
public final class AnonymousClass62 {
    ...
    public AnonymousClass62(C1036Zs c1036Zs, AudienceNetworkActivity audienceNetworkActivity) {
        this.A02 = c1036Zs;
    ...
    public final QS A03(Intent intent, RelativeLayout relativeLayout) {
        ...
        if (stringExtra != null) {
            ...
            QS qsA01 = QR.A01(c1036Zs, stringExtra);
            if (qsA01 != null) {
                relativeLayout.addView(qsA01, new RelativeLayout.LayoutParams(-1, -1));
            }
            return qsA01;
        }
        return null;
    ...
    public final void A04() {
        if (C0599Im.A28(this.A01)) {
            A02(16777216, 16777216);
        }
    }

    public final void A05() {
        if (this.A00 != null && C0599Im.A16(this.A01)) {
            this.A00.A07();
        }
    }

    public final void A06() {
        if (C0599Im.A2G(this.A01)) {
            A02(128, 128);
        }
    }

    public final void A07(Intent intent, KG kg, final RelativeLayout relativeLayout) {
        if (C0599Im.A16(this.A01)) {
            KG kg2 = KG.A03;
            if (A04[1].length() == 14) {
                throw new RuntimeException();
            }
    ...
    public final void A08(KG kg, boolean z) {
