...
public abstract class LC {
    ...
    public static void A05(C1035Zr c1035Zr, LZ lz, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        boolean isPackageInstalled = A08(c1035Zr.getPackageManager(), str);
        ...
        A02.postDelayed(new LB(new int[]{0}, str, c1035Zr, lz), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.core.C1035Zr r6, java.lang.String r7) {
        /*
            ...
            r5 = 49
            r3 = 22
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.LC.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L4e:
            r2 = 0
            if (r0 == 0) goto L5c
            android.os.Handler r0 = com.facebook.ads.redexgen.core.LC.A02
            r0.removeCallbacksAndMessages(r2)
            java.util.Set<java.lang.String> r0 = com.facebook.ads.redexgen.core.LC.A03
            r0.remove(r7)
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.2A r1 = com.facebook.ads.redexgen.core.C2B.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
            ...
            goto L4e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.LC.A06(com.facebook.ads.redexgen.X.Zr, java.lang.String):void");
    }

    public static void A07(C1035Zr c1035Zr, String str, LZ lz) {
        boolean isWithinFB = c1035Zr.getPackageName().equals(A01(30, 19, 75)) || c1035Zr.getPackageName().equals(A01(49, 22, 66));
        if (isWithinFB) {
            A05(c1035Zr, lz, str);
        } else {
            C2B.A00(c1035Zr).A0A(str, lz, 4);
        }
    }
