...
public final class C0563Hb {
    ...
    private C0563Hb A00(String str, Object obj) {
        this.A01.put((String) AbstractC0567Hf.A01(str), AbstractC0567Hf.A01(obj));
        this.A00.remove(str);
        return this;
    }

    public final C0563Hb A01(String str) {
        this.A00.add(str);
        this.A01.remove(str);
        return this;
    }

    public final C0563Hb A02(String str, long j) {
        return A00(str, Long.valueOf(j));
    }

    public final C0563Hb A03(String str, String str2) {
        return A00(str, str2);
    }
    ...
    public final Map<String, Object> A05() {
        ...
        Map<String, Object> mapUnmodifiableMap = Collections.unmodifiableMap(map);
        if (A02[0].length() == 9) {
