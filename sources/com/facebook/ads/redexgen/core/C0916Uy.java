...
public final class C0916Uy extends AbstractC0734Ny {
    ...
    static {
        A08();
        A0D = C0916Uy.class.getSimpleName();
        A0E = new HashSet(2);
        A09 = false;
        A0A = false;
        A0E.add(A05(0, 4, 113));
    ...
    public C0916Uy(C1036Zs c1036Zs, Activity activity, InterfaceC0728Ns interfaceC0728Ns) {
        super(activity, c1036Zs);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
        this.A01 = -1L;
        A0A(c1036Zs, interfaceC0728Ns);
    }

    public C0916Uy(C1036Zs c1036Zs, InterfaceC0728Ns interfaceC0728Ns) {
        super(c1036Zs);
        this.A02 = -1L;
        this.A00 = -1L;
        this.A03 = -1L;
    ...
    public final C0731Nv A0E() {
        return new C0731Nv(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
    ...
    private void A0A(C1036Zs c1036Zs, InterfaceC0728Ns interfaceC0728Ns) {
        this.A04 = c1036Zs;
        this.A06 = interfaceC0728Ns;
        this.A05 = new C0724No(this);
        A09 = AbstractC0600In.A03(this.A04);
        A0A = AbstractC0600In.A04(this.A04);
    ...
    public final WebChromeClient A0D() {
        return new C0730Nu(new WeakReference(this.A04), new WeakReference(this.A06), new WeakReference(this.A05));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC0734Ny, android.webkit.WebView
    ...
    public void setBrowserNavigationListener(InterfaceC0729Nt interfaceC0729Nt) {
        this.A07.A06(new WeakReference<>(interfaceC0729Nt));
    }

    public void setInterceptRedirectRequest(InterfaceC0727Nr interfaceC0727Nr) {
        this.A07.A05(interfaceC0727Nr);
    }
}
