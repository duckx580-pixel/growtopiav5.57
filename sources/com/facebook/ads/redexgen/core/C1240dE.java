...
public final class C1240dE {
    ...
    public /* synthetic */ C1240dE(AbstractC1235d8 abstractC1235d8) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C1234d7.A07(collection, A00(31, 1, 39));
        int i = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C1234d7.A07(collection, A00(31, 1, 39));
        C1234d7.A07(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C1234d7.A0A(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
