...
public class C0968Wz implements I6<String> {
    ...
    public final boolean A5x(String str) {
        String strA0M = IK.A0M(str);
        if (!TextUtils.isEmpty(strA0M) && ((!strA0M.contains(A00(4, 4, 100)) || strA0M.contains(A00(8, 8, 48))) && !strA0M.contains(A00(0, 4, 47)))) {
