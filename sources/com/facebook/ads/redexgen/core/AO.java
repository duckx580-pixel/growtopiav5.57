...
public final class AO {
    ...
    public final void A0B(int i, Et et) {
        this.A05.add(new AP(i, et));
        if (this.A05.size() == 1 && !this.A00.A0E()) {
            A02();
        }
    }

    public final void A0C(int i, Et et) {
        AP mediaPeriod;
        AP ap = new AP(i, et);
        this.A05.remove(ap);
    ...
    public final void A0D(int i, Et et) {
        this.A02 = new AP(i, et);
    }
    ...
    */
    public final void A0E(com.facebook.ads.redexgen.core.AM r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.AP r0 = (com.facebook.ads.redexgen.core.AP) r0
        ...
        L29:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AO.A0E(com.facebook.ads.redexgen.X.AM):void");
    }
