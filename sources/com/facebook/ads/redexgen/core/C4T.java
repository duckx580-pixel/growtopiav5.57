...
public class C4T {
    ...
    private final View A01(View view) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            C02724p c02724p = (C02724p) view3.getLayoutParams();
            if (view3 != view) {
                boolean zA02 = c02724p.A02();
    ...
    private final void A02(View view) {
        ...
        if (closest == null) {
            ...
            this.A01 = ((C02724p) closest.getLayoutParams()).A00();
        }
    }

    public final View A03(C02784w c02784w) {
        if (this.A08 != null) {
            return A00();
        }
        View viewA0G = c02784w.A0G(this.A01);
        this.A01 += this.A03;
        return viewA0G;
    }
