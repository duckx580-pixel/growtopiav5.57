...
public final class C01750v {
    ...
    private void A03(C1S c1s, JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.has(strA01)) {
            c1s.A06((JSONArray) jSONObject.get(strA01));
        }
    ...
    public final synchronized void A08(String str) throws JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
                ...
                for (int i = 0; i < jSONArray.length() && i < C1S.A00(); i++) {
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        ...
        if (this.A00.has(strOptString) && (this.A00.get(strOptString) instanceof C1S)) {
            frequencyCappingData = (C1S) this.A00.get(strOptString);
        } else {
            frequencyCappingData = new C1S(strOptString);
        }
        A03(frequencyCappingData, jSONObject);
