...
public final class C0599Im {
    public static C0599Im A01;
    ...
    public C0599Im(Context context) {
    ...
    public static int A0D(Context context) {
        return A0T(context).A2p(A0U(1410, 39, 57), Utils.FALLBACK_MAX_POLLING_INTERVAL);
    }
    ...
    public static long A0Q(Context context) {
        return A0T(context).A2q(A0U(650, 45, 58), PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED);
    }
    ...
    public static synchronized C0599Im A0T(Context context) {
        if (A01 == null) {
            A01 = new C0599Im(context);
        }
        return A01;
    }
