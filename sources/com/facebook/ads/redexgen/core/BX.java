...
public final class BX extends AbstractC0895Ud {
    ...
    static {
        ...
        A0K = (int) (LP.A02 * 8.0f);
        A0R = AbstractC02212p.A01(-1, 77);
        A0N = (int) (LP.A02 * 16.0f);
        A0U = (int) (LP.A02 * 12.0f);
    }

    public BX(C0748Om c0748Om) {
        super(c0748Om, false);
        this.A0F = new AtomicBoolean(false);
        this.A09 = false;
        this.A08 = false;
        this.A02 = c0748Om.A05();
        this.A04 = c0748Om.A09();
        ...
        A06();
        this.A0A = c0748Om.A0A();
        AbstractC0737Ob.A00(c0748Om.A05(), this, getAdInfo().A0E().A07());
        this.A0D = A01(c0748Om);
        getAdDetailsView().bringToFront();
        this.A0E = A02(c0748Om);
        ...
        A14();
        this.A06 = new C0788Qa(this.A02, c0748Om.A06(), getAdDataBundle());
        this.A0B = new C0893Ub(this);
        this.A0C = new OS(c0748Om, getAdDataBundle(), this.A0D, this.A0E, getAdDetailsView(), this.A0A, this.A0B);
        LK lkA0A = super.A07.A0A(getAdDataBundle());
        this.A02.A0G().A00(lkA0A.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A07);
        if (lkA0A.A00) {
            this.A0D.getVideoImplView().setOnClickListener(new ViewOnClickListenerC0751Op(this));
        } else if (C0599Im.A1E(getAdContextWrapper())) {
            OB.A00(this.A0D.getVideoImplView(), C0599Im.A1F(getAdContextWrapper()), new ViewOnClickListenerC0752Oq(this));
        }
        if (c0748Om.A04().A1C()) {
            this.A05 = new UP(c0748Om);
            View view = this.A05;
    ...
    private T7 A01(C0748Om c0748Om) {
        T7 t7 = (T7) c0748Om.A02();
        int iA13 = A13(c0748Om.A09());
        ImageView imageView = (ImageView) c0748Om.A03();
        int i = AbstractC0895Ud.A0F;
        int i2 = AbstractC0895Ud.A0F;
        int toolbarHeight = AbstractC0895Ud.A0F;
        imageView.setPadding(i, i2, toolbarHeight, AbstractC0895Ud.A0F);
        int toolbarHeight2 = AbstractC0895Ud.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0895Ud.A0G);
        int toolbarHeight3 = AbstractC0895Ud.A0E;
    ...
    private N5 A02(C0748Om c0748Om) {
        N5 n5A0B = c0748Om.A0B();
        n5A0B.A06(-1, AbstractC0895Ud.A0B);
        n5A0B.setPadding(AbstractC0895Ud.A0J, AbstractC0895Ud.A0J, AbstractC0895Ud.A0J, AbstractC0895Ud.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0895Ud.A0I);
    ...
    private void A05() {
        ...
        ViewOnClickListenerC0900Ui ctaButton = getCtaButton();
    ...
    private void A07() {
        ...
        switch ((QZ) r2.first) {
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0895Ud.A0H, AbstractC0895Ud.A0H, AbstractC0895Ud.A0H, AbstractC0895Ud.A0H);
        ...
        if (getAdInfo().A0H().A00() >= 0) {
            ...
            this.A03 = new LH((int) getAdInfo().A0H().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0892Ua(this));
            this.A03.A07();
        }
    }
    ...
    private void A0A(RelativeLayout relativeLayout) {
        ...
        M3.A0M(ou, 0);
        M3.A0K(ou);
        new AsyncTaskC0905Un(ou, this.A02).A05(A0M, A0M).A07(getAdDataBundle().A1S().A01());
        ...
        OW ow = new OW(c1036Zs, i, 5, A0R, -1);
        ow.setGravity(16);
    ...
    public final boolean A12(boolean z) {
        ...
        if (!z2) {
            this.A0D.A0a(EnumC0801Qn.A08);
            return true;
        }
        return false;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC0895Ud
    ...
    public final void A17() {
        new JF(((AbstractC0744Oi) this).A06.A04().A1U(), getAdEventManager()).A04(JE.A0f, null);
        if (((AbstractC0744Oi) this).A06.A09() != null) {
            MQ mqA09 = ((AbstractC0744Oi) this).A06.A09();
            if (A0H[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0H[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            mqA09.setVisibility(8);
            removeView(((AbstractC0744Oi) this).A06.A09());
        }
        removeView(this.A05);
        removeView(this.A0D);
        A04();
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC0895Ud, com.facebook.ads.redexgen.core.AbstractC0744Oi, android.view.View
