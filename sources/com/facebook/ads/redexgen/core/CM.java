    ...
    */
    public static int A00(int r7) {
        /*
            ...
            r5 = 0
        L2:
            long[] r0 = com.facebook.ads.redexgen.core.CM.A04
            int r0 = r0.length
            if (r5 >= r0) goto L15
            long[] r0 = com.facebook.ads.redexgen.core.CM.A04
            r3 = r0[r5]
        ...
        L16:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.CM.A00(int):int");
    }
    ...
    public final long A05(InterfaceC0447By interfaceC0447By, boolean z, boolean z2, int i) throws InterruptedException, IOException {
        if (this.A01 == 0) {
            if (!interfaceC0447By.AEp(this.A02, 0, 1, z)) {
                return -1L;
            }
        ...
        if (this.A00 != 1) {
            interfaceC0447By.readFully(this.A02, 1, this.A00 - 1);
        }
        this.A01 = 0;
