...
public final class C1066aM extends C5Y implements MediaViewApi, Repairable, InterfaceC03327e {
    ...
    private void A0A(View view, W7 w7) {
        ...
        String strA1C = w7.A1C();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = QR.A01(this.A07, strA1C);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C1036Zs c1036Zs, AttributeSet attributeSet, int i, int i2, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1036Zs, attributeSet, i, i2));
        A0H(new O5(c1036Zs, attributeSet, i, i2));
        this.A08 = new C3C(c1036Zs, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1036Zs, attributeSet, i, i2));
        A07();
    }

    private final void A0D(C1036Zs c1036Zs, AttributeSet attributeSet, int i, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1036Zs, attributeSet, i));
        A0H(new O5(c1036Zs, attributeSet, i));
        this.A08 = new C3C(c1036Zs, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1036Zs, attributeSet, i));
        A07();
    }

    private final void A0E(C1036Zs c1036Zs, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1036Zs, attributeSet));
        A0H(new O5(c1036Zs, attributeSet));
        this.A08 = new C3C(c1036Zs, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1036Zs, attributeSet));
        A07();
    }

    private final void A0F(C1036Zs c1036Zs, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1036Zs));
        A0H(new O5(c1036Zs));
        this.A08 = new C3C(c1036Zs);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1036Zs));
        A07();
    }

    private void A0G(W7 w7, boolean z, JU ju) {
        AsyncTaskC0905Un asyncTaskC0905UnA04 = new AsyncTaskC0905Un(this.A02, this.A07).A04();
        if (z) {
            asyncTaskC0905UnA04.A06(new C1073aT(this, w7));
        }
        asyncTaskC0905UnA04.A07(ju.getUrl());
    }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C02925k) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C02925k) nativeAd.getNativeAdApi()).A02());
    }
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1066aM.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z) {
        C1036Zs c1036ZsA11 = ((W7) nativeAdBaseApi).A11();
        C1036Zs adObjectContext = this.A07;
        adObjectContext.A0K(c1036ZsA11);
        c1036ZsA11.A0N(this);
        this.A0D = true;
        W7 w7A0L = W7.A0L(nativeAdBaseApi);
        w7A0L.A1R(this.A03);
        this.A09.setVisibility(8);
        this.A09.setImage(null, null);
        this.A05.setVisibility(8);
        this.A05.unsetNativeAd();
        ((C02895h) this.A05.getMediaViewVideoRendererApi()).A03();
        if (this.A01 != null) {
            this.A01.setVisibility(8);
            if (this.A01 instanceof C0732Nw) {
                ((C0732Nw) this.A01).A04();
            } else {
        ...
        this.A00 = this.A02;
        JU adIcon = w7A0L.getAdIcon();
        if (adIcon != null) {
            C03136f c03136fA10 = w7A0L.A10();
            if (A0F[1].charAt(7) == 'A') {
                throw new RuntimeException();
            }
            String[] strArr = A0F;
            strArr[3] = "8vonm0Gh";
            strArr[7] = "EfYx5Mmt";
            Bitmap bitmapA0M = c03136fA10.A0M(adIcon.getUrl());
            if (bitmapA0M != null) {
                this.A02.setImageBitmap(bitmapA0M);
                if (z) {
                    this.A03.post(new C1074aU(this, w7A0L));
                }
            } else {
                A0G(w7A0L, z, adIcon);
            }
            ...
            c1036ZsA11.A0E().A38(w7A0L.A0x(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (w6A15 != null) {
                w6A15.ABs(C0616Jg.A00(adErrorType));
            }
            Log.e(A04(46, 17, 121), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C1036Zs adObjectContext2 = this.A07;
                adObjectContext2.A07().AA0(A04(258, 3, 44), C8E.A0W, new C8F(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, w7A0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C1066aM.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C1066aM.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C1066aM.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        if (context instanceof C1036Zs) {
            this.A07 = (C1036Zs) context;
        } else {
            this.A07 = C02835b.A03(context);
        }
        this.A07.A0N(this);
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C02895h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C02895h) this.A05.getMediaViewVideoRendererApi()).A07(new C1067aN(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C02895h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            mediaViewVideoRenderer.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C1066aM) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
