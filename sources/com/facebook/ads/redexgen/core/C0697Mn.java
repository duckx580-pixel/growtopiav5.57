...
public final class C0697Mn extends RelativeLayout {
    public TextView A00;
    ...
    public C0697Mn(C1036Zs c1036Zs, int i, int i2, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1036Zs);
        this.A05 = new TextView(c1036Zs);
        this.A02 = new Button(c1036Zs);
        this.A01 = new Button(c1036Zs);
        ...
        int iA01 = AbstractC02212p.A01(i2, 20);
        M3.A0O(this.A02, i, A07);
        M3.A0O(this.A01, iA01, A07);
        A00();
        setGravity(17);
    }
