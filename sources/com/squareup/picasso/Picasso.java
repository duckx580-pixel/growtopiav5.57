...
public class Picasso {
    ...
    void resumeAction(Action action) {
        ...
        if (bitmapQuickMemoryCacheCheck != null) {
            ...
            if (this.loggingEnabled) {
                Utils.log("Main", MCCampaignStatus.COMPLETED, action.request.logId(), "from " + LoadedFrom.MEMORY);
                return;
            }
            return;
        }
    ...
    private void deliverAction(Bitmap bitmap, LoadedFrom loadedFrom, Action action, Exception exc) {
        ...
        if (this.loggingEnabled) {
            Utils.log("Main", MCCampaignStatus.COMPLETED, action.request.logId(), "from " + loadedFrom);
        }
    }
