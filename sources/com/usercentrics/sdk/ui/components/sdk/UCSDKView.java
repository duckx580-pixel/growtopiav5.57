...
public final class UCSDKView extends ConstraintLayout {
    ...
    public UCSDKView(Context context, UCThemeData theme, UCSDKViewModel viewModel) {
        super(context);
        ...
        this.ucCookieDialogTitle = LazyKt.lazy(new Function0<UCTextView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieDialogTitle$2
            {
                super(0);
            }
        ...
        this.ucCookieLoadingText = LazyKt.lazy(new Function0<UCTextView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieLoadingText$2
            {
                super(0);
            }
        ...
        this.ucCookieTryAgainBtn = LazyKt.lazy(new Function0<UCTextView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieTryAgainBtn$2
            {
                super(0);
            }
        ...
        this.ucCookieRetryMessage = LazyKt.lazy(new Function0<UCTextView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieRetryMessage$2
            {
                super(0);
            }
        ...
        this.ucCookieLoadingBox = LazyKt.lazy(new Function0<LinearLayout>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieLoadingBox$2
            {
                super(0);
            }
        ...
        this.ucCookieRetryBox = LazyKt.lazy(new Function0<LinearLayout>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieRetryBox$2
            {
                super(0);
            }
        ...
        this.ucCookieDialogList = LazyKt.lazy(new Function0<RecyclerView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieDialogList$2
            {
                super(0);
            }
        ...
        this.ucCookieDialogClose = LazyKt.lazy(new Function0<UCImageView>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$ucCookieDialogClose$2
            {
                super(0);
            }
    ...
    private final void bindContent() {
        ...
        getUcCookieDialogClose().setOnClickListener(new View.OnClickListener() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$$ExternalSyntheticLambda0
    ...
    public static final void bindContent$lambda$3(UCSDKView this$0, View view) {
    ...
    private final void loadInformation() {
        ...
        this.viewModel.loadInformation(new Function1<List<? extends PredefinedUIDeviceStorageContent>, Unit>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView.loadInformation.1
            {
                super(1);
            }
            ...
            public final void invoke2(List<PredefinedUIDeviceStorageContent> sdks) {
                Intrinsics.checkNotNullParameter(sdks, "sdks");
                UCSDKView.this.showSDKInfo(sdks);
            }
        }, new Function0<Unit>() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView.loadInformation.2
            {
                super(0);
            }
    ...
    public final void showRetry() {
        ...
        getUcCookieTryAgainBtn().setOnClickListener(new View.OnClickListener() { // from class: com.usercentrics.sdk.ui.components.sdk.UCSDKView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showRetry$lambda$4(UCSDKView this$0, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.loadInformation();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void showSDKInfo(List<PredefinedUIDeviceStorageContent> data) {
        getUcCookieLoadingBox().setVisibility(8);
        getUcCookieRetryBox().setVisibility(8);
