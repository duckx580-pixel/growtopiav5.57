...
public final class GeolocationRuleset$$serializer implements GeneratedSerializer<GeolocationRuleset> {
    ...
    public GeolocationRuleset deserialize(Decoder decoder) {
        ...
        return new GeolocationRuleset(i, strDecodeStringElement, zDecodeBooleanElement, null);
    }
    ...
    public void serialize(Encoder encoder, GeolocationRuleset value) {
        ...
        GeolocationRuleset.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
