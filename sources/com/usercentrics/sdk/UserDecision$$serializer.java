...
public final class UserDecision$$serializer implements GeneratedSerializer<UserDecision> {
    ...
    public UserDecision deserialize(Decoder decoder) {
        ...
        return new UserDecision(i, strDecodeStringElement, zDecodeBooleanElement, null);
    }
    ...
    public void serialize(Encoder encoder, UserDecision value) {
        ...
        UserDecision.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
