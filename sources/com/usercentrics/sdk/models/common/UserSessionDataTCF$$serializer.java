...
public final class UserSessionDataTCF$$serializer implements GeneratedSerializer<UserSessionDataTCF> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, UserSessionDataTCF.$childSerializers[1], StringSerializer.INSTANCE};
    }
    ...
    public UserSessionDataTCF deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = UserSessionDataTCF.$childSerializers;
        ...
        return new UserSessionDataTCF(i, str, list, strDecodeStringElement, null);
    }
    ...
    public void serialize(Encoder encoder, UserSessionDataTCF value) {
        ...
        UserSessionDataTCF.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
