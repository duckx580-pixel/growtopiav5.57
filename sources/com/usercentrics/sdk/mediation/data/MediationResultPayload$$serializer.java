...
public final class MediationResultPayload$$serializer implements GeneratedSerializer<MediationResultPayload> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{MediationResultPayload.$childSerializers[0]};
    }
    ...
    public MediationResultPayload deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = MediationResultPayload.$childSerializers;
        int i = 1;
    ...
    public void serialize(Encoder encoder, MediationResultPayload value) {
        ...
        compositeEncoderBeginStructure.encodeSerializableElement(descriptor2, 0, MediationResultPayload.$childSerializers[0], value.applied);
