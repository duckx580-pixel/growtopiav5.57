...
public final class ConsentsBufferEntry$$serializer implements GeneratedSerializer<ConsentsBufferEntry> {
    ...
    public ConsentsBufferEntry deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            saveConsentsData = (SaveConsentsData) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, SaveConsentsData$$serializer.INSTANCE, null);
            i = 3;
        } else {
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    saveConsentsData2 = (SaveConsentsData) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, SaveConsentsData$$serializer.INSTANCE, saveConsentsData2);
                    i2 |= 2;
                }
            }
            i = i2;
        ...
        return new ConsentsBufferEntry(i, jDecodeLongElement, saveConsentsData, null);
    }
    ...
    public void serialize(Encoder encoder, ConsentsBufferEntry value) {
        ...
        ConsentsBufferEntry.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
