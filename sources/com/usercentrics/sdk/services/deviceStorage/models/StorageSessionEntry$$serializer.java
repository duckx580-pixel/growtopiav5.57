...
public final class StorageSessionEntry$$serializer implements GeneratedSerializer<StorageSessionEntry> {
    ...
    public StorageSessionEntry deserialize(Decoder decoder) {
        ...
        return new StorageSessionEntry(i, strDecodeStringElement, jDecodeLongElement, null);
    }
    ...
    public void serialize(Encoder encoder, StorageSessionEntry value) {
        ...
        StorageSessionEntry.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
