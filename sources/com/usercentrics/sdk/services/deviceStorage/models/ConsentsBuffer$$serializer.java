...
public final class ConsentsBuffer$$serializer implements GeneratedSerializer<ConsentsBuffer> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{ConsentsBuffer.$childSerializers[0]};
    }
    ...
    public ConsentsBuffer deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = ConsentsBuffer.$childSerializers;
        int i = 1;
    ...
    public void serialize(Encoder encoder, ConsentsBuffer value) {
        ...
        compositeEncoderBeginStructure.encodeSerializableElement(descriptor2, 0, ConsentsBuffer.$childSerializers[0], value.entries);
