...
public final class IdAndName$$serializer implements GeneratedSerializer<IdAndName> {
    ...
    public IdAndName deserialize(Decoder decoder) {
        ...
        return new IdAndName(i, iDecodeIntElement, strDecodeStringElement, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, IdAndName value) {
        ...
        IdAndName.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
