...
public final class TCFSpecialPurpose$$serializer implements GeneratedSerializer<TCFSpecialPurpose> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, TCFSpecialPurpose.$childSerializers[1], IntSerializer.INSTANCE, StringSerializer.INSTANCE};
    }
    ...
    public TCFSpecialPurpose deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = TCFSpecialPurpose.$childSerializers;
        ...
        return new TCFSpecialPurpose(i2, str, list, i, strDecodeStringElement, null);
    }
    ...
    public void serialize(Encoder encoder, TCFSpecialPurpose value) {
        ...
        TCFSpecialPurpose.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
