...
public final class UsercentricsConsentHistoryEntry$$serializer implements GeneratedSerializer<UsercentricsConsentHistoryEntry> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BooleanSerializer.INSTANCE, UsercentricsConsentHistoryEntry.$childSerializers[1], LongSerializer.INSTANCE};
    }
    ...
    public UsercentricsConsentHistoryEntry deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = UsercentricsConsentHistoryEntry.$childSerializers;
        ...
        return new UsercentricsConsentHistoryEntry(i, zDecodeBooleanElement, usercentricsConsentType, jDecodeLongElement, null);
    }
    ...
    public void serialize(Encoder encoder, UsercentricsConsentHistoryEntry value) {
        ...
        UsercentricsConsentHistoryEntry.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
