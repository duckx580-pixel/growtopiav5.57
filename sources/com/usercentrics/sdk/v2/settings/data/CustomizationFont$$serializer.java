...
public final class CustomizationFont$$serializer implements GeneratedSerializer<CustomizationFont> {
    ...
    public CustomizationFont deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            num = (Integer) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, IntSerializer.INSTANCE, null);
            i = 3;
        } else {
            boolean z = true;
            int i2 = 0;
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    num2 = (Integer) compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 1, IntSerializer.INSTANCE, num2);
                    i2 |= 2;
                }
            }
            num = num2;
    ...
    public void serialize(Encoder encoder, CustomizationFont value) {
        ...
        CustomizationFont.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
