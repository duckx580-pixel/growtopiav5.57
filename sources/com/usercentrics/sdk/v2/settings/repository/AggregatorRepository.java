...
/* JADX INFO: compiled from: AggregatorRepository.kt */
...
public final class AggregatorRepository extends NetworkOrchestrator implements IAggregatorRepository {
    ...
    static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return AggregatorRepository.this.fetchServices(null, null, false, this);
        }
    }
    ...
    */
    public java.lang.Object fetchServices(java.lang.String r5, java.util.List<com.usercentrics.sdk.v2.settings.data.BasicConsentTemplate> r6, boolean r7, kotlin.coroutines.Continuation<? super java.util.List<com.usercentrics.sdk.v2.settings.data.UsercentricsService>> r8) {
        /*
            r4 = this;
        ...
        L4f:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.usercentrics.sdk.v2.settings.repository.AggregatorRepository.fetchServices(java.lang.String, java.util.List, boolean, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    private final NewServiceTemplates parseJson(String responseBody) {
        ...
        KSerializer<Object> kSerializerSerializer = SerializersKt.serializer(json.getSerializersModule(), Reflection.typeOf(NewServiceTemplates.class));
        Intrinsics.checkNotNull(kSerializerSerializer, "null cannot be cast to non-null type kotlinx.serialization.KSerializer<T of kotlinx.serialization.internal.Platform_commonKt.cast>");
        return (NewServiceTemplates) json.decodeFromString(kSerializerSerializer, responseBody);
    }
}
