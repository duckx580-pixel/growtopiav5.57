...
public final class DefaultGeoRule$$serializer implements GeneratedSerializer<DefaultGeoRule> {
    ...
    public DefaultGeoRule deserialize(Decoder decoder) {
        ...
        return new DefaultGeoRule(i, strDecodeStringElement, zDecodeBooleanElement, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, DefaultGeoRule value) {
        ...
        DefaultGeoRule.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
