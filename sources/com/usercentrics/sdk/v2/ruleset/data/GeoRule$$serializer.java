...
public final class GeoRule$$serializer implements GeneratedSerializer<GeoRule> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, GeoRule.$childSerializers[1]};
    }
    ...
    public GeoRule deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = GeoRule.$childSerializers;
        ...
        return new GeoRule(i, strDecodeStringElement, list, serializationConstructorMarker);
    }
    ...
    public void serialize(Encoder encoder, GeoRule value) {
        ...
        GeoRule.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
