...
public final class ConsentStringObjectDto$$serializer implements GeneratedSerializer<ConsentStringObjectDto> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{LongSerializer.INSTANCE, ConsentStringObjectDto.$childSerializers[1]};
    }
    ...
    public ConsentStringObjectDto deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = ConsentStringObjectDto.$childSerializers;
        List list2 = null;
        ...
        return new ConsentStringObjectDto(i, jDecodeLongElement, list, null);
    }
    ...
    public void serialize(Encoder encoder, ConsentStringObjectDto value) {
        ...
        ConsentStringObjectDto.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
