...
public final class DataTransferObject$$serializer implements GeneratedSerializer<DataTransferObject> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, DataTransferObjectConsent$$serializer.INSTANCE, DataTransferObjectSettings$$serializer.INSTANCE, DataTransferObject.$childSerializers[3], LongSerializer.INSTANCE};
    }
    ...
    public DataTransferObject deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = DataTransferObject.$childSerializers;
        String strDecodeStringElement = null;
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            String strDecodeStringElement2 = compositeDecoderBeginStructure.decodeStringElement(descriptor2, 0);
            DataTransferObjectConsent dataTransferObjectConsent2 = (DataTransferObjectConsent) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, DataTransferObjectConsent$$serializer.INSTANCE, null);
            DataTransferObjectSettings dataTransferObjectSettings2 = (DataTransferObjectSettings) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, DataTransferObjectSettings$$serializer.INSTANCE, null);
            ...
            while (z) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    dataTransferObjectConsent3 = (DataTransferObjectConsent) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 1, DataTransferObjectConsent$$serializer.INSTANCE, dataTransferObjectConsent3);
                    i2 |= 2;
                } else if (iDecodeElementIndex == 2) {
                    dataTransferObjectSettings3 = (DataTransferObjectSettings) compositeDecoderBeginStructure.decodeSerializableElement(descriptor2, 2, DataTransferObjectSettings$$serializer.INSTANCE, dataTransferObjectSettings3);
                    i2 |= 4;
        ...
        return new DataTransferObject(i, str, dataTransferObjectConsent, dataTransferObjectSettings, list, jDecodeLongElement, null);
    }
    ...
    public void serialize(Encoder encoder, DataTransferObject value) {
        ...
        DataTransferObject.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
