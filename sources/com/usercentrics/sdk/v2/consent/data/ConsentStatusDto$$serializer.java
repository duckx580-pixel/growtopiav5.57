...
public final class ConsentStatusDto$$serializer implements GeneratedSerializer<ConsentStatusDto> {
    ...
    public ConsentStatusDto deserialize(Decoder decoder) {
        ...
        return new ConsentStatusDto(i, zDecodeBooleanElement, str, strDecodeStringElement, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, ConsentStatusDto value) {
        ...
        ConsentStatusDto.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
