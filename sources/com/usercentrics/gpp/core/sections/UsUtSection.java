...
public final class UsUtSection extends UsStateSection {
    ...
    public UsUtSection() {
        ...
        fieldDefinitionArr[4] = new FieldDefinition("SensitiveDataProcessingOptOutNotice", FieldType.INT, 2, null, 0, 8, null);
        fieldDefinitionArr[5] = new FieldDefinition("SaleOptOut", FieldType.INT, 2, null, 0, 8, null);
        fieldDefinitionArr[6] = new FieldDefinition("TargetedAdvertisingOptOut", FieldType.INT, 2, null, 0, 8, null);
        FieldType fieldType = FieldType.INT_ARRAY;
        ArrayList arrayList = new ArrayList(8);
        for (int i = 0; i < 8; i++) {
            arrayList.add(0);
        }
        fieldDefinitionArr[7] = new FieldDefinition("SensitiveDataProcessing", fieldType, 2, 8, arrayList);
        fieldDefinitionArr[8] = new FieldDefinition("KnownChildSensitiveDataConsents", FieldType.INT, 2, null, 0, 8, null);
    ...
    /* JADX INFO: compiled from: UsStateSections.kt */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, d2 = {"Lcom/usercentrics/gpp/core/sections/UsUtSection$Companion;", "", "()V", "decode", "Lcom/usercentrics/gpp/core/sections/UsUtSection;", "encodedString", "", "usercentrics_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public static final class Companion {
        ...
        public final UsUtSection decode(String encodedString) {
            Intrinsics.checkNotNullParameter(encodedString, "encodedString");
            UsUtSection usUtSection = new UsUtSection();
            usUtSection.decodeWithGpc(encodedString);
            return usUtSection;
        }
    }
}
