...
public final class Feature$$serializer implements GeneratedSerializer<Feature> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, IntSerializer.INSTANCE, StringSerializer.INSTANCE, Feature.$childSerializers[3]};
    }
    ...
    public Feature deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = Feature.$childSerializers;
    ...
    public void serialize(Encoder encoder, Feature value) {
        ...
        Feature.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
