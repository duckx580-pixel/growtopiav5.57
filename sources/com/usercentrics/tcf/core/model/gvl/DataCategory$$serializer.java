...
/* JADX INFO: compiled from: DataCategory.kt */
...
public final class DataCategory$$serializer implements GeneratedSerializer<DataCategory> {
    ...
    public DataCategory deserialize(Decoder decoder) {
        ...
        return new DataCategory(i, iDecodeIntElement, str, strDecodeStringElement, null);
    }
    ...
    public void serialize(Encoder encoder, DataCategory value) {
        ...
        DataCategory.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
