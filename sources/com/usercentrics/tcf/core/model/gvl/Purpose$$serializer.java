...
public final class Purpose$$serializer implements GeneratedSerializer<Purpose> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{StringSerializer.INSTANCE, IntSerializer.INSTANCE, StringSerializer.INSTANCE, Purpose.$childSerializers[3]};
    }
    ...
    public Purpose deserialize(Decoder decoder) {
        ...
        KSerializer[] kSerializerArr = Purpose.$childSerializers;
    ...
    public void serialize(Encoder encoder, Purpose value) {
        ...
        Purpose.write$Self$usercentrics_release(value, compositeEncoderBeginStructure, descriptor2);
