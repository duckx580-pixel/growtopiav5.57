...
public class c {
    ...
    private static WindowManager f3260a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f3260a != null) {
            ...
            f3260a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f3260a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0050a c0050a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0050a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0050a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f3261a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f3262a);
