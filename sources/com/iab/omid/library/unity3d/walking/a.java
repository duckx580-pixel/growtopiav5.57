...
public class a {
    ...
    private final HashMap<View, String> f3266a = new HashMap<>();
    private final HashMap<View, C0050a> b = new HashMap<>();
    ...
    private void a(e eVar, com.iab.omid.library.unity3d.adsession.a aVar) {
        ...
        C0050a c0050a = this.b.get(view);
        if (c0050a != null) {
            c0050a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0050a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f3266a.get(view);
        if (str != null) {
            this.f3266a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f3266a.put(viewC, adSessionId);
                            a(aVar);
