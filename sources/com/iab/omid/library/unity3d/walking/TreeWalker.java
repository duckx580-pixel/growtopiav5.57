...
public class TreeWalker implements a.InterfaceC0048a {
    ...
    private List<TreeWalkerTimeLogger> f3264a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f3264a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f3264a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        a.C0050a c0050aC = this.f.c(view);
        if (c0050aC == null) {
            return false;
        }
        com.iab.omid.library.unity3d.utils.c.a(jSONObject, c0050aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.unity3d.processor.a.InterfaceC0048a
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f3264a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f3264a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f3264a.contains(treeWalkerTimeLogger)) {
            this.f3264a.remove(treeWalkerTimeLogger);
        }
    }
}
