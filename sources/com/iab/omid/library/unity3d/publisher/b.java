...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0049b implements Runnable {
        ...
        private final WebView f3258a;

        RunnableC0049b() {
            this.f3258a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0049b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
