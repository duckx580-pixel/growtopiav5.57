...
public class c {
    ...
    private static WindowManager f3297a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f3297a != null) {
            ...
            f3297a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f3297a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0054a c0054a) {
        com.iab.omid.library.vungle.internal.e eVarA = c0054a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0054a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f3298a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f3299a);
