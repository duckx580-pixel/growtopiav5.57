...
public class TreeWalker implements a.InterfaceC0045a {
    ...
    private List<TreeWalkerTimeLogger> f3230a = new ArrayList();
    ...
    private void a(long j2) {
        if (this.f3230a.size() > 0) {
            for (TreeWalkerTimeLogger treeWalkerTimeLogger : this.f3230a) {
    ...
    private boolean a(View view, JSONObject jSONObject) {
        a.C0046a c0046aC = this.f.c(view);
        if (c0046aC == null) {
            return false;
        }
        com.iab.omid.library.ironsrc.utils.c.a(jSONObject, c0046aC);
        return true;
    }
    ...
    @Override // com.iab.omid.library.ironsrc.processor.a.InterfaceC0045a
    ...
    public void addTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f3230a.contains(treeWalkerTimeLogger)) {
            return;
        }
        this.f3230a.add(treeWalkerTimeLogger);
    }
    ...
    public void removeTimeLogger(TreeWalkerTimeLogger treeWalkerTimeLogger) {
        if (this.f3230a.contains(treeWalkerTimeLogger)) {
            this.f3230a.remove(treeWalkerTimeLogger);
        }
    }
}
