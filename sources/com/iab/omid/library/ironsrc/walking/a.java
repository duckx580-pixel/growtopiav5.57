...
public class a {
    ...
    private final HashMap<View, String> f3232a = new HashMap<>();
    private final HashMap<View, C0046a> b = new HashMap<>();
    ...
    public static class C0046a {
        ...
        public C0046a(e eVar, String str) {
            this.f3233a = eVar;
            a(str);
        }
    ...
    private void a(e eVar, com.iab.omid.library.ironsrc.adsession.a aVar) {
        ...
        C0046a c0046a = this.b.get(view);
        if (c0046a != null) {
            c0046a.a(aVar.getAdSessionId());
        } else {
            this.b.put(view, new C0046a(eVar, aVar.getAdSessionId()));
        }
    }
    ...
    public String d(View view) {
        ...
        String str = this.f3232a.get(view);
        if (str != null) {
            this.f3232a.remove(view);
        }
        return str;
    }
                ...
                if (aVar.f()) {
                    ...
                    if (viewC != null) {
                        ...
                        if (strA == null) {
                            ...
                            this.f3232a.put(viewC, adSessionId);
                            a(aVar);
