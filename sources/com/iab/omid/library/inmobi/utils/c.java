...
public class c {
    ...
    private static WindowManager f3193a;
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f3193a != null) {
            ...
            f3193a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f3193a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0043a c0043a) {
        com.iab.omid.library.inmobi.internal.e eVarA = c0043a.a();
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f3194a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f3195a);
