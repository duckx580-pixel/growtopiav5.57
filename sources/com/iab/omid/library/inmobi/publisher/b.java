...
public class b extends AdSessionStatePublisher {
    ...
    class RunnableC0042b implements Runnable {
        ...
        private final WebView f3191a;

        RunnableC0042b() {
            this.f3191a = b.this.g;
        }
    ...
    public void b() {
        super.b();
        new Handler().postDelayed(new RunnableC0042b(), Math.max(4000 - (this.h == null ? 4000L : TimeUnit.MILLISECONDS.convert(f.b() - this.h.longValue(), TimeUnit.NANOSECONDS)), 2000L));
        this.g = null;
    }
