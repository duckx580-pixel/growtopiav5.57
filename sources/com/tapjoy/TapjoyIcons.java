...
public class TapjoyIcons {
    ...
    public static Bitmap getBackDisabledImage(float f) {
        ...
        int iRound = Math.round(f);
        if (iRound == 1) {
            str = BACK_DISABLED_1X;
        } else if (iRound == 2) {
            str = BACK_DISABLED_2X;
        } else {
            str = BACK_DISABLED_3X;
        }
        return getImageBitmap(str);
    }
    ...
    public static Bitmap getForwardEnabledImage(float f) {
        ...
        int iRound = Math.round(f);
        if (iRound == 1) {
            str = FORWARD_ENABLED_1X;
        } else if (iRound == 2) {
            str = FORWARD_ENABLED_2X;
        } else {
            str = FORWARD_ENABLED_3X;
        }
        return getImageBitmap(str);
    }
    ...
    public static Bitmap getForwardDisabledImage(float f) {
        ...
        int iRound = Math.round(f);
        if (iRound == 1) {
            str = FORWARD_DISABLED_1X;
        } else if (iRound == 2) {
            str = FORWARD_DISABLED_2X;
        } else {
            str = FORWARD_DISABLED_3X;
        }
        return getImageBitmap(str);
    }
    ...
    public static Bitmap getCloseCircularImage(float f) {
        String str;
        if (Math.round(f) == 1) {
            str = CLOSE_CIRCULAR_1X;
        } else {
            str = CLOSE_CIRCULAR_2X;
        }
        return getImageBitmap(str);
    }
