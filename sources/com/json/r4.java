...
public final /* data */ class r4 {
    ...
    public final r4 a(String name, boolean bidder) {
        Intrinsics.checkNotNullParameter(name, "name");
        return new r4(name, bidder);
    }
    ...
    public boolean equals(Object other) {
        ...
        r4 r4Var = (r4) other;
        return Intrinsics.areEqual(this.name, r4Var.name) && this.bidder == r4Var.bidder;
    }
