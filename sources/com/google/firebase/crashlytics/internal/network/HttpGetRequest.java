...
public class HttpGetRequest {
    ...
    private String createUrlWithParams(String str, Map<String, String> map) throws UnsupportedEncodingException {
        ...
        if (!str.endsWith(v8.i.c)) {
            strCreateParamsString = v8.i.c + strCreateParamsString;
        }
        return str + strCreateParamsString;
    }
    ...
    private String createParamsString(Map<String, String> map) throws UnsupportedEncodingException {
        ...
        sb.append(next.getKey()).append(v8.i.b).append(next.getValue() != null ? URLEncoder.encode(next.getValue(), HTTP.UTF_8) : "");
        while (it.hasNext()) {
            Map.Entry<String, String> next2 = it.next();
            sb.append(v8.i.c).append(next2.getKey()).append(v8.i.b).append(next2.getValue() != null ? URLEncoder.encode(next2.getValue(), HTTP.UTF_8) : "");
        }
        return sb.toString();
    }
