...
public final class SessionsSettings {
    ...
    public final long m297getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo295getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo295getSessionRestartTimeoutFghU774();
        if (durationMo295getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo295getSessionRestartTimeoutFghU774.getRawValue();
            if (m296isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo295getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo295getSessionRestartTimeoutFghU774();
        if (durationMo295getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo295getSessionRestartTimeoutFghU7742.getRawValue();
            if (m296isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m296isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m4950isPositiveimpl(sessionRestartTimeout) && Duration.m4945isFiniteimpl(sessionRestartTimeout);
    }
