...
class ClearTextEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m202lambda$new$0$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(View view) {
    ...
    /* synthetic */ void m203lambda$new$1$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(View view, boolean z) {
    ...
    ClearTextEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onClick(View view) {
                this.f$0.m202lambda$new$0$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(view);
            }
        };
        this.onFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m203lambda$new$1$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(view, z);
            }
        };
        ...
        if (editText != null) {
            editText.post(new Runnable() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda3
                ...
                public final void run() {
                    this.f$0.m204lambda$tearDown$2$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate();
                }
            });
        }
    }
    ...
    /* synthetic */ void m204lambda$tearDown$2$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate() {
        animateIcon(true);
    }
    ...
    private ValueAnimator getAlphaAnimator(float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m200lambda$getAlphaAnimator$3$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m200lambda$getAlphaAnimator$3$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(ValueAnimator valueAnimator) {
    ...
    private ValueAnimator getScaleAnimator() {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.ClearTextEndIconDelegate$$ExternalSyntheticLambda4
            @Override // android.animation.ValueAnimator.AnimatorUpdateListener
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m201lambda$getScaleAnimator$4$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(valueAnimator);
            }
        });
        return valueAnimatorOfFloat;
    }
    ...
    /* synthetic */ void m201lambda$getScaleAnimator$4$comgoogleandroidmaterialtextfieldClearTextEndIconDelegate(ValueAnimator valueAnimator) {
