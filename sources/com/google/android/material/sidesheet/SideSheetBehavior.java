...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(this.viewRef.get(), new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m197lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(i);
                }
            });
        }
    }
    ...
    /* synthetic */ void m197lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i) {
    ...
    private ValueAnimator.AnimatorUpdateListener getCoplanarFinishAnimatorUpdateListener() {
        ...
        return new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m196lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(marginLayoutParams, coplanarSiblingAdjacentMargin, coplanarSiblingView, valueAnimator);
            }
        };
    }
    ...
    /* synthetic */ void m196lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    class StateSettlingTracker {
        private final Runnable continueSettlingRunnable = new Runnable() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$StateSettlingTracker$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m198lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker();
            }
        };
        ...
        /* synthetic */ void m198lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    private AccessibilityViewCommand createAccessibilityViewCommandForState(final int i) {
        return new AccessibilityViewCommand() { // from class: com.google.android.material.sidesheet.SideSheetBehavior$$ExternalSyntheticLambda1
            ...
            public final boolean perform(View view, AccessibilityViewCommand.CommandArguments commandArguments) {
                return this.f$0.m195lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(i, view, commandArguments);
            }
        };
    }
    ...
    /* synthetic */ boolean m195lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i, View view, AccessibilityViewCommand.CommandArguments commandArguments) {
        setState(i);
        return true;
    }
}
