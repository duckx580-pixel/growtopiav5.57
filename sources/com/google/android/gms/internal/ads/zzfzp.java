...
class zzfzp extends zzfzn implements List {
    final /* synthetic */ zzfzq zzf;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    zzfzp(zzfzq zzfzqVar, Object obj, @CheckForNull List list, zzfzn zzfznVar) {
    ...
    public final List subList(int i, int i2) {
        ...
        return this.zzf.zzh(this.zza, listSubList, zzfznVar);
    }
