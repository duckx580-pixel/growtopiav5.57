...
final class zzhce extends zzgze implements RandomAccess, zzhbp, zzhcy {
    ...
    public final zzhbp zzf(int i) {
        if (i >= this.zzc) {
            return new zzhce(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzhce(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
