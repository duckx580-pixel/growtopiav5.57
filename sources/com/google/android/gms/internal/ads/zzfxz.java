...
public final class zzfxz {
    public static int zza(int i, int i2, String str) {
        ...
        if (i < 0) {
            strZzb = zzfyo.zzb("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else {
            if (i2 < 0) {
                throw new IllegalArgumentException("negative size: " + i2);
            }
            strZzb = zzfyo.zzb("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
    ...
    public static void zzg(boolean z, String str, long j) {
        if (!z) {
            throw new IllegalArgumentException(zzfyo.zzb(str, Long.valueOf(j)));
        }
    }

    public static void zzh(boolean z, String str, int i, int i2) {
        if (!z) {
            throw new IllegalArgumentException(zzfyo.zzb(str, Integer.valueOf(i), Integer.valueOf(i2)));
        }
    }

    public static void zzi(int i, int i2, int i3) {
        if (i < 0 || i2 < i || i2 > i3) {
            throw new IndexOutOfBoundsException((i < 0 || i > i3) ? zzl(i, i3, "start index") : (i2 < 0 || i2 > i3) ? zzl(i2, i3, "end index") : zzfyo.zzb("end index (%s) must not be less than start index (%s)", Integer.valueOf(i2), Integer.valueOf(i)));
        }
    }
    ...
    private static String zzl(int i, int i2, String str) {
        if (i < 0) {
            return zzfyo.zzb("%s (%s) must not be negative", str, Integer.valueOf(i));
        }
        if (i2 >= 0) {
            return zzfyo.zzb("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i), Integer.valueOf(i2));
        }
        throw new IllegalArgumentException("negative size: " + i2);
    }
}
