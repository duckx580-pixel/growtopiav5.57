...
public final class zzegg {
    ...
    public final ListenableFuture zza() {
        try {
            ...
            return measurementManagerFuturesFrom == null ? zzgfo.zzg(new IllegalStateException("MeasurementManagerFutures is null")) : measurementManagerFuturesFrom.getMeasurementApiStatusAsync();
        } catch (Exception e) {
            return zzgfo.zzg(e);
        }
    }
