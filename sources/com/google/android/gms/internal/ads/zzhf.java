...
public final class zzhf extends zzfz {
    ...
    private static int zzk(String str) throws zzhe {
        try {
            ...
            throw new zzhe("Resource identifier must be an integer.", null, 1004);
        }
    }
    ...
    private static AssetFileDescriptor zzl(Context context, zzgm zzgmVar) throws zzhe {
        ...
        if (TextUtils.equals("rawresource", uriNormalizeScheme.getScheme())) {
            ...
            if (pathSegments.size() != 1) {
                throw new zzhe("rawresource:// URI must have exactly one path element, found " + pathSegments.size());
            }
            identifier = zzk(pathSegments.get(0));
        } else {
            if (!TextUtils.equals("android.resource", uriNormalizeScheme.getScheme())) {
                throw new zzhe("Unsupported URI scheme (" + uriNormalizeScheme.getScheme() + "). Only android.resource is supported.", null, 1004);
            }
        ...
        try {
            ...
            throw new zzhe("Resource is compressed: ".concat(String.valueOf(String.valueOf(uriNormalizeScheme))), null, 2000);
    ...
    public final int zza(byte[] bArr, int i, int i2) throws zzhe {
        ...
        if (i4 == -1) {
            ...
            throw new zzhe("End of stream reached having not read sufficient data.", new EOFException(), 2000);
        }
        long j2 = this.zze;
        if (j2 != -1) {
            this.zze = j2 - ((long) i4);
    ...
    public final long zzb(zzgm zzgmVar) throws zzhe {
        ...
        this.zzb = zzgmVar;
        zzi(zzgmVar);
        AssetFileDescriptor assetFileDescriptorZzl = zzl(this.zza, zzgmVar);
        ...
        if (length != -1) {
            try {
                if (zzgmVar.zze > length) {
                    throw new zzhe(null, null, 2008);
                }
            } catch (zzhe e) {
                throw e;
            } catch (IOException e2) {
                throw new zzhe(null, e2, 2000);
            }
        }
