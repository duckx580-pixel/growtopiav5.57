...
final class zzheg {
    static /* bridge */ /* synthetic */ void zza(byte b, byte b2, byte b3, byte b4, char[] cArr, int i) throws zzhbt {
    ...
    static /* bridge */ /* synthetic */ void zzc(byte b, byte b2, char[] cArr, int i) throws zzhbt {
        if (b < -62 || zzg(b2)) {
            throw new zzhbt("Protocol message had invalid UTF-8.");
        }
    ...
    */
    static /* bridge */ /* synthetic */ void zzb(byte r2, byte r3, byte r4, char[] r5, int r6) throws com.google.android.gms.internal.ads.zzhbt {
        /*
            boolean r0 = zzg(r3)
            if (r0 != 0) goto L2c
            r0 = -96
        ...
        L2c:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzheg.zzb(byte, byte, byte, char[], int):void");
    }
}
