...
class zzfzn extends AbstractCollection {
    final Object zza;
    Collection zzb;
    ...
    zzfzn(zzfzq zzfzqVar, Object obj, @CheckForNull Collection collection, zzfzn zzfznVar) {
        this.zze = zzfzqVar;
        this.zza = obj;
        this.zzb = collection;
        this.zzc = zzfznVar;
    ...
    final void zza() {
        ...
        zzfzq zzfzqVar = this.zze;
        zzfzqVar.zza.put(this.zza, this.zzb);
    }
    ...
    final void zzb() {
        ...
        if (this.zzb.isEmpty()) {
            zzfzq zzfzqVar = this.zze;
            Collection collection = (Collection) zzfzqVar.zza.get(this.zza);
            if (collection != null) {
                this.zzb = collection;
            }
        }
