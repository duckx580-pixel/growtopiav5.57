...
final class zzhek {
    ...
    static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzhbt {
        zzheh zzhehVar = zza;
        if (byteBuffer.hasArray()) {
            return zzhehVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        return byteBuffer.isDirect() ? zzhei.zzc(byteBuffer, i, i2) : zzheh.zzc(byteBuffer, i, i2);
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzhbt {
