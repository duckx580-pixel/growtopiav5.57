...
public final class zzbic extends RemoteCreator {
    ...
    public final zzbgm zza(View view, HashMap map, HashMap map2) {
        try {
            IBinder iBinderZze = ((zzbgp) getRemoteCreatorInstance(view.getContext())).zze(ObjectWrapper.wrap(view), ObjectWrapper.wrap(map), ObjectWrapper.wrap(map2));
            if (iBinderZze == null) {
                return null;
            }
            ...
            return iInterfaceQueryLocalInterface instanceof zzbgm ? (zzbgm) iInterfaceQueryLocalInterface : new zzbgk(iBinderZze);
