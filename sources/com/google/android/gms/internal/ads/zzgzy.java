...
final class zzgzy extends zzhac {
    ...
    /* synthetic */ zzgzy(InputStream inputStream, int i, zzgzx zzgzxVar) {
        super(null);
    ...
    public final zzgzs zzv() throws IOException {
        ...
        int i2 = this.zzi;
        if (iZzi <= i - i2 && iZzi > 0) {
            zzgzs zzgzsVarZzv = zzgzs.zzv(this.zzf, i2, iZzi);
            this.zzi += iZzi;
            return zzgzsVarZzv;
        }
        if (iZzi == 0) {
        ...
        if (bArrZzN != null) {
            return zzgzs.zzv(bArrZzN, 0, bArrZzN.length);
        }
        int i3 = this.zzi;
        int i4 = this.zzg;
        int i5 = i4 - i3;
    ...
    public final String zzw() throws IOException {
        ...
        if (iZzi > 0) {
            ...
            int i2 = this.zzi;
            if (iZzi <= i - i2) {
                String str = new String(this.zzf, i2, iZzi, zzhbr.zza);
                this.zzi += iZzi;
                return str;
            }
        }
        ...
        if (iZzi > this.zzg) {
            return new String(zzM(iZzi, false), zzhbr.zza);
        }
        zzK(iZzi);
        String str2 = new String(this.zzf, this.zzi, iZzi, zzhbr.zza);
        this.zzi += iZzi;
        return str2;
    }
    ...
    public final String zzx() throws IOException {
        ...
        return zzhek.zzh(bArrZzM, i, iZzi);
    }
