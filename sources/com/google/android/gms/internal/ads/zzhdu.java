...
class zzhdu extends AbstractMap {
    private Object[] zza;
    private int zzb;
    private boolean zzd;
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int iCompareTo = comparable.compareTo(((zzhdo) this.zza[i2]).zza());
            if (iCompareTo > 0) {
                return -(i + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int iCompareTo2 = comparable.compareTo(((zzhdo) this.zza[i4]).zza());
            if (iCompareTo2 < 0) {
                i2 = i4 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object zzm(int i) {
        zzo();
        Object value = ((zzhdo) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zzhdo(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final boolean equals(Object obj) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzg(i2).equals(zzhduVar.zzg(i2))) {
                return false;
            }
        }
        if (i != size) {
    ...
    public final Object get(Object obj) {
        ...
        return iZzl >= 0 ? ((zzhdo) this.zza[iZzl]).getValue() : this.zzc.get(comparable);
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int iZzl = zzl(comparable);
        if (iZzl >= 0) {
            return ((zzhdo) this.zza[iZzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
        ...
        this.zza[i] = new zzhdo(this, comparable, obj);
        this.zzb++;
        return null;
    }
