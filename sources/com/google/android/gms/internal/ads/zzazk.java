...
public final class zzazk {
    ...
    public zzazk(int i, int i2, int i3, int i4, int i5, int i6, int i7, boolean z) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = i3;
        this.zzd = z;
        this.zze = new zzazz(i4);
        this.zzf = new zzbah(i5, i6, i7);
    }
    ...
    private final void zzp(String str, boolean z, float f, float f2, float f3, float f4) {
        if (str != null) {
            ...
            synchronized (this.zzg) {
                ...
                if (z) {
                    this.zzi.add(str);
                    this.zzj.add(new zzazv(f, f2, f3, f4, this.zzi.size() - 1));
                }
            }
        }
    }
