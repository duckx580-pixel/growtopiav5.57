...
public abstract class zzbpz extends zzaym implements zzbqa {
    ...
    public static zzbqa zzb(IBinder iBinder) {
        ...
        return iInterfaceQueryLocalInterface instanceof zzbqa ? (zzbqa) iInterfaceQueryLocalInterface : new zzbpy(iBinder);
    }
    ...
    protected final boolean zzdF(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        switch (i) {
            ...
            case 4:
                ...
                return true;
            case 5:
                zzbgc zzbgcVarZzl = zzl();
                parcel2.writeNoException();
                zzayn.zzf(parcel2, zzbgcVarZzl);
                return true;
            case 6:
                String strZzr = zzr();
                parcel2.writeNoException();
            ...
            case 15:
                ...
                parcel2.writeNoException();
                zzayn.zzf(parcel2, iObjectWrapperZzo);
                return true;
            case 16:
                Bundle bundleZzi = zzi();
                parcel2.writeNoException();
                zzayn.zze(parcel2, bundleZzi);
                return true;
            case 17:
                boolean zZzB = zzB();
                parcel2.writeNoException();
