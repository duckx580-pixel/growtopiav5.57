...
public final class ai {
    ...
    private static final s f3159a = new s("PhoneskyVerificationUtils");
    ...
    private static boolean c(Signature[] signatureArr) {
        if (signatureArr == null || (signatureArr.length) == 0) {
            f3159a.e("Phonesky package is not signed -- possibly self-built package. Could not verify.", new Object[0]);
            return false;
        }
