...
final class bn {
    ...
    final com.google.android.play.integrity.internal.ae f3133a;
    ...
    bn(Context context, com.google.android.play.integrity.internal.s sVar, at atVar, k kVar) {
        ...
        this.e = atVar;
        this.f = kVar;
        com.google.android.play.integrity.internal.ae aeVar = new com.google.android.play.integrity.internal.ae(context, sVar, "ExpressIntegrityService", bo.f3134a, new com.google.android.play.integrity.internal.z() { // from class: com.google.android.play.core.integrity.bd
    ...
    final Task c(Activity activity, Bundle bundle) {
        ...
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.f3133a.t(new bh(this, taskCompletionSource, bundle, activity, taskCompletionSource, i), taskCompletionSource);
    ...
    public final Task d(String str, long j, long j2, int i) {
        ...
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.f3133a.t(new bg(this, taskCompletionSource, 0, str, j, j2, taskCompletionSource), taskCompletionSource);
        return taskCompletionSource.getTask();
    }
    ...
    public final Task e(long j, int i) {
        ...
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        this.f3133a.t(new bf(this, taskCompletionSource, 0, j, taskCompletionSource), taskCompletionSource);
        return taskCompletionSource.getTask();
    }
}
