...
final class aj {
    ...
    final com.google.android.play.integrity.internal.ae f3110a;
    ...
    aj(Context context, com.google.android.play.integrity.internal.s sVar, at atVar, k kVar) {
        ...
        if (com.google.android.play.integrity.internal.ai.b(context)) {
            this.f3110a = new com.google.android.play.integrity.internal.ae(context, sVar, "IntegrityService", ak.f3111a, new com.google.android.play.integrity.internal.z() { // from class: com.google.android.play.core.integrity.ae
    ...
    final Task b(Activity activity, Bundle bundle) {
        ...
        this.f3110a.t(new ag(this, taskCompletionSource, bundle, activity, taskCompletionSource, i), taskCompletionSource);
    ...
    public final Task c(IntegrityTokenRequest integrityTokenRequest) {
        ...
        try {
            ...
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            this.f3110a.t(new af(this, taskCompletionSource, bArrDecode, lCloudProjectNumber, null, taskCompletionSource, integrityTokenRequest), taskCompletionSource);
            return taskCompletionSource.getTask();
