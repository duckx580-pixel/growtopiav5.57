...
public abstract class AbstractExecutionThreadService implements Service {
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(strServiceName).length() + 3 + String.valueOf(strValueOf).length()).append(strServiceName).append(" [").append(strValueOf).append(v8.i.e).toString();
    }
