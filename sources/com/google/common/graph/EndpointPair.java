...
public abstract class EndpointPair<N> implements Iterable<N> {
    ...
    private static final class Unordered<N> extends EndpointPair<N> {
        ...
        public String toString() {
            ...
            return new StringBuilder(String.valueOf(strValueOf).length() + 4 + String.valueOf(strValueOf2).length()).append(v8.i.d).append(strValueOf).append(", ").append(strValueOf2).append(v8.i.e).toString();
        }
    }
}
