...
public final class AndroidDynamicDeviceInfoDataSource implements DynamicDeviceInfoDataSource {
    ...
    private final String getTimeZone() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    private final int getNetworkType() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private final boolean adbStatus() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        Boolean boolValueOf;
        try {
            boolean z = true;
    ...
    private final boolean getAirplaneMode() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public final boolean getStayOnWhilePluggedIn() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
