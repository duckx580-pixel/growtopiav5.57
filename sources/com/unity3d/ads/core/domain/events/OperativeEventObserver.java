    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FlowKt.launchIn(FlowKt.onEach(OperativeEventObserver.this.operativeEventRepository.getOperativeEvents(), new C01002(OperativeEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(OperativeEventObserver.this.defaultDispatcher));
                return Unit.INSTANCE;
            }
        ...
        static final class C01002 extends SuspendLambda implements Function2<OperativeEventRequestOuterClass.OperativeEventRequest, Continuation<? super Unit>, Object> {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ OperativeEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C01002(OperativeEventObserver operativeEventObserver, Continuation<? super C01002> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C01002 c01002 = new C01002(this.this$0, continuation);
                c01002.L$0 = obj;
                return c01002;
            }
            ...
            public final Object invoke(OperativeEventRequestOuterClass.OperativeEventRequest operativeEventRequest, Continuation<? super Unit> continuation) {
                return ((C01002) create(operativeEventRequest, continuation)).invokeSuspend(Unit.INSTANCE);
            }
