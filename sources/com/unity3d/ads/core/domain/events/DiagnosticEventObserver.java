    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                FlowKt.launchIn(FlowKt.onEach(DiagnosticEventObserver.this.diagnosticEventRepository.getDiagnosticEvents(), new C00992(DiagnosticEventObserver.this, null)), CoroutineScopeKt.CoroutineScope(DiagnosticEventObserver.this.defaultDispatcher));
                return Unit.INSTANCE;
            }
        ...
        static final class C00992 extends SuspendLambda implements Function2<List<? extends DiagnosticEventRequestOuterClass.DiagnosticEvent>, Continuation<? super Unit>, Object> {
            /* synthetic */ Object L$0;
            int label;
            final /* synthetic */ DiagnosticEventObserver this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00992(DiagnosticEventObserver diagnosticEventObserver, Continuation<? super C00992> continuation) {
                super(2, continuation);
            ...
            @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
            public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                C00992 c00992 = new C00992(this.this$0, continuation);
                c00992.L$0 = obj;
                return c00992;
            }
            ...
            public final Object invoke2(List<DiagnosticEventRequestOuterClass.DiagnosticEvent> list, Continuation<? super Unit> continuation) {
                return ((C00992) create(list, continuation)).invokeSuspend(Unit.INSTANCE);
            }
