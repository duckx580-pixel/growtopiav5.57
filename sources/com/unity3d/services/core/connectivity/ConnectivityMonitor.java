...
public class ConnectivityMonitor {
    ...
    public static void setConnectionMonitoring(boolean z) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        _webappMonitoring = z;
        updateListeningStatus();
    }

    public static void addListener(IConnectivityListener iConnectivityListener) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (_listeners == null) {
    ...
    public static void removeListener(IConnectivityListener iConnectivityListener) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static void stopAll() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        _listeners = null;
        _webappMonitoring = false;
        updateListeningStatus();
    }

    private static void updateListeningStatus() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private static void startListening() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (_listening) {
            return;
        }
        _listening = true;
    ...
    private static void initConnectionStatus() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private static void sendToWebview(ConnectivityEvent connectivityEvent, boolean z, int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
