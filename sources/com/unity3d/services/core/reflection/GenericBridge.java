...
public abstract class GenericBridge {
    ...
    public GenericBridge(Map<String, Class<?>[]> map) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public Class<?> classForName() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public boolean exists() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private void buildMethodMap() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        boolean z = true;
    ...
    private Method getReflectiveMethod(Class<?> cls, String str, Class<?>... clsArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public void callVoidMethod(String str, Object obj, Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public <T> T callNonVoidMethod(String str, Object obj, Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        Method method = getMethod(str);
        if (method == null) {
            DeviceLog.debug("ERROR: Could not find method %s", str);
            return null;
