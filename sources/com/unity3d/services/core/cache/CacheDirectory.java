...
public class CacheDirectory {
    ...
    public boolean testCacheDirectory(File file) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private void createNoMediaFile(File file) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
