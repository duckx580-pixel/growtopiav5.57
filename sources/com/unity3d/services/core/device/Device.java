...
public class Device {
    ...
    public static String getIdfi() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static int getNetworkType() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (ClientProperties.getApplicationContext() == null) {
            return -1;
        }
        try {
    ...
    */
    ...
    public static boolean isRooted() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    private static Boolean oldAdbStatus() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    private static Boolean newAdbStatus() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public static String getCertificateFingerprint() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
