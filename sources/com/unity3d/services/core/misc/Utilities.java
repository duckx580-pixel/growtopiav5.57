...
public class Utilities {
    ...
    public static String Sha256(byte[] bArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (bArr == null) {
            return null;
        }
        try {
    ...
    public static String Sha256(InputStream inputStream) throws IllegalAccessException, NoSuchMethodException, IOException, InvocationTargetException {
        if (inputStream == null) {
            return null;
        }
        try {
    ...
    public static void wrapCustomerListener(Runnable runnable) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
            runnable.run();
        } catch (Exception e) {
