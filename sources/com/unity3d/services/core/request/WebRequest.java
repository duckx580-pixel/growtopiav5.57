...
public class WebRequest {
    ...
    private HttpURLConnection getHttpUrlConnectionWithHeaders() throws IllegalAccessException, NoSuchMethodException, NetworkIOException, IllegalArgumentException, InvocationTargetException {
