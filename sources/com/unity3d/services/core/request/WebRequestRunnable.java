...
public class WebRequestRunnable implements Runnable {
    ...
    private void makeRequest(String str, String str2, Map<String, List<String>> map, String str3, int i, int i2) throws IllegalAccessException, MalformedURLException, NoSuchMethodException, InvocationTargetException {
        if (this._canceled) {
            return;
        }
