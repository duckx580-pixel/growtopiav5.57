...
public class MetricCommonTags {
    ...
    public Map<String, String> toMap() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (mediationIsEmpty()) {
    ...
    private void refreshMediationData() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
