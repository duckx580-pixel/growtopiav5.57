...
public final class SDKMetrics {
    ...
    private static final class NullInstance implements SDKMetricsSender {
        ...
        public void sendEvent(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            DeviceLog.debug("Metric " + str + " was skipped from being sent");
        }

        @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
        public void sendEvent(String str, String str2, Map<String, String> map) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            sendEvent(str);
        }

        public void sendEvent(String str, Map<String, String> map) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            sendEvent(str);
        }

        @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
        public void sendMetric(Metric metric) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            DeviceLog.debug("Metric " + metric + " was skipped from being sent");
        }

        @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
        public void sendMetrics(List<Metric> list) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            DeviceLog.debug("Metrics: " + list + " was skipped from being sent");
        }

        @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
        public void sendMetricWithInitState(Metric metric) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            sendMetric(metric);
        }
