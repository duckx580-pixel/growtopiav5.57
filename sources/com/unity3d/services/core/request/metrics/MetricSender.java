...
public class MetricSender extends MetricSenderBase implements IServiceComponent {
    ...
    @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
    public void sendEvent(String event, String value, Map<String, String> tags) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Override // com.unity3d.services.core.request.metrics.SDKMetricsSender
    public void sendMetrics(List<Metric> metrics) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
