...
public class EnvironmentCheck {
    ...
    public static boolean testProGuard() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public static boolean testCacheDirectory() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
