...
public class BaseTimer implements IBaseTimer {
    ...
    private void addLifecycleListener() {
        ...
        lifecycleCache.addActiveListener(new IAppActiveListener() { // from class: com.unity3d.services.core.timer.BaseTimer.1
            ...
            public void onAppStateChanged(boolean z) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
                if (z) {
    ...
    public void start(ScheduledExecutorService scheduledExecutorService) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Override // com.unity3d.services.core.timer.IBaseTimer
    public boolean resume() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        boolean z;
        ScheduledExecutorService scheduledExecutorService = this._timerService;
        if (scheduledExecutorService == null || scheduledExecutorService.isShutdown()) {
            z = false;
    ...
    public void restart(ScheduledExecutorService scheduledExecutorService) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private void schedule() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
