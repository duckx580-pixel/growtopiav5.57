...
public class WebViewApp implements IWebViewBridgeInvoker {
    ...
    private void invokeJavascriptMethod(String str, String str2, JSONArray jSONArray) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public boolean sendEvent(Enum r6, Enum r7, Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!isWebAppLoaded()) {
    ...
    public static ErrorState create(final Configuration configuration, boolean z) throws IllegalThreadStateException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        DeviceLog.entered();
        if (z) {
    ...
    private static class WebAppClient extends WebViewClient {
        ...
        public boolean onRenderProcessGone(android.webkit.WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        @Override // android.webkit.WebViewClient
        public void onPageFinished(android.webkit.WebView webView, String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            super.onPageFinished(webView, str);
            DeviceLog.debug("Unity Ads SDK finished loading URL inside WebView: " + str);
        }

        @Override // android.webkit.WebViewClient
        public boolean shouldOverrideUrlLoading(android.webkit.WebView webView, String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            DeviceLog.debug("Unity Ads SDK attempts to load URL inside WebView: " + str);
            return false;
        }

        @Override // android.webkit.WebViewClient
        public void onReceivedError(android.webkit.WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
