...
public final class SharedInstances {
    ...
    private static final IInvocationCallbackInvoker webViewAppInvocationCallbackInvoker = new IInvocationCallbackInvoker() { // from class: com.unity3d.services.core.webview.bridge.SharedInstances$$ExternalSyntheticLambda0
        ...
        public final void invokeCallback(Invocation invocation) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static final void webViewAppInvocationCallbackInvoker$lambda$0(Invocation it) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
