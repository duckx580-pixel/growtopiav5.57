...
public final class WebViewBridgeInterface {
    ...
    @JavascriptInterface
    public final void handleInvocation(String data) throws IllegalAccessException, JSONException, NoSuchMethodException, InvocationTargetException {
    ...
    public final void onHandleInvocation(WebView view, WebMessageCompat message, Uri sourceOrigin, boolean isMainFrame, JavaScriptReplyProxy replyProxy) throws IllegalAccessException, JSONException, NoSuchMethodException, InvocationTargetException {
        String str;
