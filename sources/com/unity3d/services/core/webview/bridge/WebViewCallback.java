...
public class WebViewCallback implements Parcelable {
    ...
    public void invoke(Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        invoke(CallbackStatus.OK, null, objArr);
    }

    private void invoke(CallbackStatus callbackStatus, Enum r4, Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        String str;
    ...
    public void error(Enum r2, Object... objArr) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
