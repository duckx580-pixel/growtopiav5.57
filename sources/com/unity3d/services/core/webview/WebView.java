...
public class WebView extends android.webkit.WebView implements IServiceComponent {
    ...
    public WebView(Context context, boolean z, IWebViewBridge webViewBridge, IInvocationCallbackInvoker callbackInvoker, IExperiments experiments) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(webViewBridge, "webViewBridge");
        Intrinsics.checkNotNullParameter(callbackInvoker, "callbackInvoker");
        ...
        if (zIsWebMessageEnabled && zIsFeatureSupported) {
            ...
            WebViewCompat.addWebMessageListener(webView2, "handleInvocation", SetsKt.setOf(ProxyConfig.MATCH_ALL_SCHEMES), new WebViewCompat.WebMessageListener() { // from class: com.unity3d.services.core.webview.WebView$$ExternalSyntheticLambda0
                ...
                public final void onPostMessage(android.webkit.WebView webView3, WebMessageCompat webMessageCompat, Uri uri, boolean z2, JavaScriptReplyProxy javaScriptReplyProxy) throws IllegalAccessException, JSONException, NoSuchMethodException, InvocationTargetException {
