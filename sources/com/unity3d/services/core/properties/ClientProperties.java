...
public class ClientProperties {
    ...
    public static String getAppVersion() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static boolean isAppDebuggable() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        boolean zEquals;
