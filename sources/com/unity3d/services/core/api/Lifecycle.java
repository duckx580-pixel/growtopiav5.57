...
public class Lifecycle {
    ...
    @WebViewExposed
    public static void register(JSONArray jSONArray, WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @WebViewExposed
    public static void unregister(WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (ClientProperties.getApplication() != null) {
            if (getLifecycleListener() != null) {
