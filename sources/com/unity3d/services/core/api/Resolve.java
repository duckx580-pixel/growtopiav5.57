...
public class Resolve {
    @WebViewExposed
    public static void resolve(final String str, String str2, WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (WebRequestThread.resolve(str2, new IResolveHostListener() { // from class: com.unity3d.services.core.api.Resolve.1
            ...
            public void onResolve(String str3, String str4) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
            ...
            @Override // com.unity3d.services.core.request.IResolveHostListener
            public void onFailed(String str3, ResolveHostError resolveHostError, String str4) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
                if (WebViewApp.getCurrentApp() != null) {
