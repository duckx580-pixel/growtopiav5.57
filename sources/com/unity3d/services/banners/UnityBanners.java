...
public final class UnityBanners {
    ...
    private class BannerWrapper extends FrameLayout {
        ...
        public void destroy() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    private void _destroy() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Deprecated
    public static void loadBanner(Activity activity, String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        DeviceLog.entered();
    ...
    @Deprecated
    public static void destroy() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
