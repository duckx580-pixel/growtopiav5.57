...
public class BannerWebPlayerContainer extends RelativeLayout {
    ...
    protected void onAttachedToWindow() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super.onAttachedToWindow();
        BannerBridge.didAttach(this._bannerAdId);
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onDetachedFromWindow() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Override // android.view.View
    protected void onVisibilityChanged(View view, int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (view == this) {
    ...
    @Override // android.view.View
    public void setAlpha(float f) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super.setAlpha(f);
