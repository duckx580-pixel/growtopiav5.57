...
public class BannerBridge {
    ...
    public static void load(String str, String str2, UnityBannerSize unityBannerSize) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static void resize(String str, int i, int i2, int i3, int i4, float f) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void visibilityChanged(String str, int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didLoad(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didDestroy(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didAttach(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didDetach(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didAttachScarBanner(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void didDetachScarBanner(String str) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
