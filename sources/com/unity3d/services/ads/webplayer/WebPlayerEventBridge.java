...
public class WebPlayerEventBridge {
    public static void error(String str, String str2, String str3) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public static void sendFrameUpdate(String str, int i, int i2, int i3, int i4, float f) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void sendGetFrameResponse(String str, String str2, int i, int i2, int i3, int i4, float f) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
