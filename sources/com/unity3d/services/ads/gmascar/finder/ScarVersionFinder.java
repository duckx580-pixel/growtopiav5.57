...
public class ScarVersionFinder implements IInitializationStatusListener {
    ...
    public void getVersion() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
    ...
    public int getVersionCode() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
