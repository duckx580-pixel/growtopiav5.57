...
public class VideoPlayerView extends VideoView {
    ...
    public boolean prepare(String str, final float f, int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        DeviceLog.entered();
        this._videoUrl = str;
        setOnPreparedListener(new MediaPlayer.OnPreparedListener() { // from class: com.unity3d.services.ads.video.VideoPlayerView.3
            ...
            public void onPrepared(MediaPlayer mediaPlayer) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public void play() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        DeviceLog.entered();
    ...
    public void pause() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
            super.pause();
    ...
    @Override // android.widget.VideoView, android.widget.MediaController.MediaPlayerControl
    public void seekTo(int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
            super.seekTo(i);
    ...
    public void setVolume(Float f) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        try {
