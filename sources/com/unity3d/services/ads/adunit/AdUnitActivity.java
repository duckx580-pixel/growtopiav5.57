...
public class AdUnitActivity extends Activity implements IAdUnitActivity {
    ...
    protected void onCreate(Bundle bundle) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    @Override // android.app.Activity
    protected void onStart() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super.onStart();
        this._controller.onStart();
    }

    @Override // android.app.Activity
    protected void onStop() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super.onStop();
    ...
    @Override // android.app.Activity
    protected void onPause() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        super.onPause();
