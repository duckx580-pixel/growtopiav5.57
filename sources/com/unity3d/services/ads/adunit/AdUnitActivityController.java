...
public class AdUnitActivityController {
    ...
    public void onCreate(Bundle bundle) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public void onStart() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!this._eventSender.canSend()) {
    ...
    public void onStop() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!this._eventSender.canSend()) {
            if (this._adUnitActivity.isFinishing()) {
                return;
            }
    ...
    public void onResume() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!this._eventSender.canSend()) {
            if (this._adUnitActivity.isFinishing()) {
                return;
            }
    ...
    public void onPause() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!this._eventSender.canSend()) {
            if (this._adUnitActivity.isFinishing()) {
                return;
            }
    ...
    public void onDestroy() throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (!this._eventSender.canSend()) {
            if (this._adUnitActivity.isFinishing()) {
                return;
            }
    ...
    */
    ...
    private boolean handleViewPlacement(View view) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (view == null) {
            this._adUnitActivity.finish();
    ...
    public boolean setSystemUiVisibility(int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
    ...
    public void setLayoutInDisplayCutoutMode(int i) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
