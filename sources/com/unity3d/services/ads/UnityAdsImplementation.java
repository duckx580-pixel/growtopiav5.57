...
public final class UnityAdsImplementation implements IUnityAds {
    ...
    public void initialize(Context context, String str, boolean z, IUnityAdsInitializationListener iUnityAdsInitializationListener) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        DeviceLog.entered();
    ...
    @Override // com.unity3d.services.ads.IUnityAds
    public void getToken(final IUnityAdsTokenListener iUnityAdsTokenListener) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        if (((AlternativeFlowReader) Utilities.getService(AlternativeFlowReader.class)).invoke()) {
