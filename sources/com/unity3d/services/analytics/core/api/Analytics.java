...
public class Analytics {
    ...
    @WebViewExposed
    public static void addExtras(final String str, WebViewCallback webViewCallback) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException {
