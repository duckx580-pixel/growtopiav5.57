...
public final class AdPayload$CacheableReplacement$$serializer implements GeneratedSerializer<AdPayload.CacheableReplacement> {
    ...
    public AdPayload.CacheableReplacement deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement3 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 2, BooleanSerializer.INSTANCE, null);
            i = 7;
        } else {
            boolean z = true;
            int i2 = 0;
        ...
        return new AdPayload.CacheableReplacement(i, (String) objDecodeNullableSerializableElement, (String) objDecodeNullableSerializableElement2, (Boolean) objDecodeNullableSerializableElement3, (SerializationConstructorMarker) null);
    }
