...
public final class SignaledAd$$serializer implements GeneratedSerializer<SignaledAd> {
    ...
    public SignaledAd deserialize(Decoder decoder) {
        ...
        return new SignaledAd(i, (String) objDecodeNullableSerializableElement, jDecodeLongElement, (String) objDecodeNullableSerializableElement2, j, iDecodeIntElement, null);
    }
