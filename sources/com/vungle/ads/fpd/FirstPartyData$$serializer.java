...
public final class FirstPartyData$$serializer implements GeneratedSerializer<FirstPartyData> {
    ...
    public FirstPartyData deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement5 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 4, new LinkedHashMapSerializer(StringSerializer.INSTANCE, StringSerializer.INSTANCE), null);
            i = 31;
        } else {
            boolean z2 = true;
            int i2 = 0;
        ...
        return new FirstPartyData(i, (SessionContext) objDecodeNullableSerializableElement, (Demographic) objDecodeNullableSerializableElement2, (Location) objDecodeNullableSerializableElement3, (Revenue) objDecodeNullableSerializableElement4, (Map) objDecodeNullableSerializableElement5, null);
    }
