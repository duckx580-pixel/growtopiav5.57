...
public final class Location$$serializer implements GeneratedSerializer<Location> {
    ...
    public Location deserialize(Decoder decoder) {
        ...
        return new Location(i, (String) objDecodeNullableSerializableElement, (String) objDecodeNullableSerializableElement2, (Integer) objDecodeNullableSerializableElement3, null);
    }
