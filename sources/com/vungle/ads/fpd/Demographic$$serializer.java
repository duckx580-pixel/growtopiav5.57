...
public final class Demographic$$serializer implements GeneratedSerializer<Demographic> {
    ...
    public Demographic deserialize(Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            objDecodeNullableSerializableElement4 = compositeDecoderBeginStructure.decodeNullableSerializableElement(descriptor2, 3, IntSerializer.INSTANCE, null);
            i = 15;
        } else {
            boolean z = true;
            int i2 = 0;
        ...
        return new Demographic(i, (Integer) objDecodeNullableSerializableElement, (Integer) objDecodeNullableSerializableElement2, (Integer) objDecodeNullableSerializableElement3, (Integer) objDecodeNullableSerializableElement4, null);
    }
