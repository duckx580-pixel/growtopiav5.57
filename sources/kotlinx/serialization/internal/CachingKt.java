...
public final class CachingKt {
    ...
    static {
        ...
        try {
            ...
            objM3590constructorimpl = Result.m3590constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
        ...
        if (Result.m3597isSuccessimpl(objM3590constructorimpl)) {
            ...
            objM3590constructorimpl = true;
        }
        Object objM3590constructorimpl2 = Result.m3590constructorimpl(objM3590constructorimpl);
        if (Result.m3596isFailureimpl(objM3590constructorimpl2)) {
            objM3590constructorimpl2 = false;
        }
        useClassValue = ((Boolean) objM3590constructorimpl2).booleanValue();
    }
