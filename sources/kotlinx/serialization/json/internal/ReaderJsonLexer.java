...
public final class ReaderJsonLexer extends AbstractJsonLexer {
    ...
    protected void appendRange(int fromIndex, int toIndex) {
        Intrinsics.checkNotNullExpressionValue(getEscapedString().append(getSource().getBuffer(), fromIndex, toIndex - fromIndex), "this.append(value, start…x, endIndex - startIndex)");
    }
}
