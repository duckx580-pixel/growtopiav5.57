...
public interface ReceiveChannel<E> {
    ...
    Object mo5096receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo5097tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo5097tryReceivePtdJZtk = receiveChannel.mo5097tryReceivePtdJZtk();
            if (ChannelResult.m5112isSuccessimpl(objMo5097tryReceivePtdJZtk)) {
                return (E) ChannelResult.m5108getOrThrowimpl(objMo5097tryReceivePtdJZtk);
            }
            Throwable thM5106exceptionOrNullimpl = ChannelResult.m5106exceptionOrNullimpl(objMo5097tryReceivePtdJZtk);
            if (thM5106exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM5106exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo5096receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m5107getOrNullimpl(r4)
                return r4
            */
