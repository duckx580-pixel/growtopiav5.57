...
public interface SendChannel<E> {
    ...
    Object mo5092trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m5112isSuccessimpl(objMo5092trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5106exceptionOrNullimpl = ChannelResult.m5106exceptionOrNullimpl(objMo5092trySendJP2dKIU);
