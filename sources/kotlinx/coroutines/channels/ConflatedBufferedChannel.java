...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM5120trySendImplMj0NB7M = conflatedBufferedChannel.m5120trySendImplMj0NB7M(e, true);
        if (objM5120trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5106exceptionOrNullimpl(objM5120trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM5120trySendImplMj0NB7M = conflatedBufferedChannel.m5120trySendImplMj0NB7M(e, true);
        if (!(objM5120trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo5092trySendJP2dKIU(E element) {
        return m5120trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5120trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5118trySendDropLatestMj0NB7M(element, isSendOp) : m5119trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5118trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo5092trySendJP2dKIU = super.mo5092trySendJP2dKIU(element);
        if (ChannelResult.m5112isSuccessimpl(objMo5092trySendJP2dKIU) || ChannelResult.m5110isClosedimpl(objMo5092trySendJP2dKIU)) {
            return objMo5092trySendJP2dKIU;
        }
    ...
    private final Object m5119trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo5092trySendJP2dKIU = mo5092trySendJP2dKIU(element);
        if (!(objMo5092trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo5092trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m5106exceptionOrNullimpl(objMo5092trySendJP2dKIU);
