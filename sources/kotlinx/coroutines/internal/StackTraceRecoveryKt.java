...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM3590constructorimpl = Result.m3590constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m3593exceptionOrNullimpl(objM3590constructorimpl) == null) {
            obj2 = objM3590constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM3590constructorimpl2 = Result.m3590constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM3590constructorimpl2 = Result.m3590constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m3593exceptionOrNullimpl(objM3590constructorimpl2) == null) {
            obj = objM3590constructorimpl2;
        }
