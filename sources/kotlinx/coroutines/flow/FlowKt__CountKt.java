...
final /* synthetic */ class FlowKt__CountKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {17}, m = HelpshiftEvent.DATA_MESSAGE_COUNT, n = {"i"}, s = {"L$0"})
    ...
    /* JADX INFO: compiled from: Count.kt */
    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {29}, m = HelpshiftEvent.DATA_MESSAGE_COUNT, n = {"i"}, s = {"L$0"})
