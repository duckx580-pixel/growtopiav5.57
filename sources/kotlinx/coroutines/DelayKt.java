...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo5149scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m5080delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m5081toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m5081toDelayMillisLRDsOJo(long j) {
        if (Duration.m4915compareToLRDsOJo(j, Duration.INSTANCE.m5019getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m4934getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
