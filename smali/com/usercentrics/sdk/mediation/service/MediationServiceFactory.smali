...
.method public final build()Lcom/usercentrics/sdk/mediation/service/MediationService;
    ...
    .line 21
    const-string v2, "Firebase Advertising"
    ...
    .line 20
    invoke-direct {v1, v2, v4, v3}, Lcom/usercentrics/sdk/mediation/sdk/FirebaseAdvertisingMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;I)V
    ...
    invoke-direct {v7, v8, v9}, Lcom/usercentrics/sdk/mediation/sdk/IronSourceMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;)V
    ...
    iget-object v10, p0, Lcom/usercentrics/sdk/mediation/service/MediationServiceFactory;->logger:Lcom/usercentrics/sdk/log/UsercentricsLogger;

    invoke-direct {v8, v9, v10}, Lcom/usercentrics/sdk/mediation/sdk/CrashlyticsMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;)V
    ...
    invoke-virtual {v4}, Lcom/usercentrics/sdk/mediation/data/UsercentricsMediation;->getSingularTemplateId()Ljava/lang/String;

    move-result-object v4

    new-instance v8, Lcom/usercentrics/sdk/mediation/sdk/SingularMediationSDK;

    const-string v9, "Singular"

    iget-object v10, p0, Lcom/usercentrics/sdk/mediation/service/MediationServiceFactory;->logger:Lcom/usercentrics/sdk/log/UsercentricsLogger;

    invoke-direct {v8, v9, v10}, Lcom/usercentrics/sdk/mediation/sdk/SingularMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;)V
    ...
    invoke-virtual {v4}, Lcom/usercentrics/sdk/mediation/data/UsercentricsMediation;->getAppsFlyerTemplateId()Ljava/lang/String;

    move-result-object v4

    new-instance v8, Lcom/usercentrics/sdk/mediation/sdk/AppsFlyerMediationSDK;

    const-string v9, "AppsFlyer"

    iget-object v10, p0, Lcom/usercentrics/sdk/mediation/service/MediationServiceFactory;->logger:Lcom/usercentrics/sdk/log/UsercentricsLogger;

    invoke-direct {v8, v9, v10}, Lcom/usercentrics/sdk/mediation/sdk/AppsFlyerMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;)V
    ...
    invoke-virtual {v4}, Lcom/usercentrics/sdk/mediation/data/UsercentricsMediation;->getAirbridgeTemplateId()Ljava/lang/String;

    move-result-object v4

    new-instance v8, Lcom/usercentrics/sdk/mediation/sdk/AirBridgeMediationSDK;

    const-string v9, "AirBridge"

    iget-object v10, p0, Lcom/usercentrics/sdk/mediation/service/MediationServiceFactory;->logger:Lcom/usercentrics/sdk/log/UsercentricsLogger;

    invoke-direct {v8, v9, v10}, Lcom/usercentrics/sdk/mediation/sdk/AirBridgeMediationSDK;-><init>(Ljava/lang/String;Lcom/usercentrics/sdk/log/UsercentricsLogger;)V
