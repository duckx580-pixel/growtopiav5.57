###### Class com.json.ep (com.ironsource.ep)
...
.method public a()Lcom/ironsource/tk;
    ...
    iget-object v0, p0, Lcom/ironsource/ep;->d:Lcom/ironsource/i3;
    ...
    invoke-virtual {v0}, Lcom/ironsource/cm;->c()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v4, p0, Lcom/ironsource/ep;->c:Lcom/ironsource/x2;

    invoke-direct {v1, v2, v3, v4, v0}, Lcom/ironsource/vk;-><init>(Ljava/lang/String;Lcom/ironsource/oo;Lcom/ironsource/x2;Z)V

    invoke-virtual {v1}, Lcom/ironsource/vk;->b()Lcom/ironsource/uk;

    move-result-object v4

    new-instance v0, Lcom/ironsource/cp;

    invoke-direct {v0, v4}, Lcom/ironsource/cp;-><init>(Lcom/ironsource/uk;)V

    invoke-virtual {v0}, Lcom/ironsource/cp;->a()V
    ...
    invoke-virtual {v1}, Lcom/unity3d/ironsourceads/rewarded/RewardedAdRequest;->getProviderName$mediationsdk_release()Lcom/ironsource/oo;

    move-result-object v1

    invoke-direct {v6, v0, v1}, Lcom/ironsource/d5;-><init>(Ljava/lang/String;Lcom/ironsource/oo;)V
    ...
    iget-object v1, p0, Lcom/ironsource/ep;->b:Lcom/unity3d/ironsourceads/rewarded/RewardedAdLoaderListener;

    invoke-direct {v5, v0, v1}, Lcom/ironsource/dp;-><init>(Lcom/ironsource/jt;Lcom/unity3d/ironsourceads/rewarded/RewardedAdLoaderListener;)V
    ...
    invoke-direct {v9, v8, v0}, Lcom/ironsource/wo;-><init>(Lcom/ironsource/j3;Ljava/util/concurrent/Executor;)V

    new-instance v2, Lcom/ironsource/bp;
    ...
    :try_end_86
    .catch Ljava/lang/Exception; {:try_start_22 .. :try_end_86} :catch_87
    ...
    instance-of v1, v0, Lcom/ironsource/fq;

    if-eqz v1, :cond_9a

    check-cast v0, Lcom/ironsource/fq;

    invoke-virtual {v0}, Lcom/ironsource/fq;->a()Lcom/ironsource/mediationsdk/logger/IronSourceError;
    ...
    new-instance v2, Lcom/ironsource/dp;

    sget-object v3, Lcom/ironsource/ve;->a:Lcom/ironsource/ve;

    iget-object v4, p0, Lcom/ironsource/ep;->b:Lcom/unity3d/ironsourceads/rewarded/RewardedAdLoaderListener;

    invoke-direct {v2, v3, v4}, Lcom/ironsource/dp;-><init>(Lcom/ironsource/jt;Lcom/unity3d/ironsourceads/rewarded/RewardedAdLoaderListener;)V

    new-instance v3, Lcom/ironsource/jb;

    invoke-direct {v3, v1, v2, v8, v0}, Lcom/ironsource/jb;-><init>(Lcom/unity3d/ironsourceads/rewarded/RewardedAdRequest;Lcom/ironsource/dp;Lcom/ironsource/j3;Lcom/ironsource/mediationsdk/logger/IronSourceError;)V
