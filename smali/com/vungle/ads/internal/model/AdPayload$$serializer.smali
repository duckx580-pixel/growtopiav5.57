###### Class com.vungle.ads.internal.model.AdPayload$$serializer (com.vungle.ads.internal.model.AdPayload$$serializer)
...
.method public deserialize(Lkotlinx/serialization/encoding/Decoder;)Lcom/vungle/ads/internal/model/AdPayload;
    ...
    if-eq v15, v7, :cond_f4

    if-eqz v15, :cond_df

    if-eq v15, v6, :cond_d2

    if-eq v15, v5, :cond_b0

    if-eq v15, v3, :cond_98
    ...
    invoke-direct {v7, v15, v4}, Lkotlinx/serialization/internal/LinkedHashMapSerializer;-><init>(Lkotlinx/serialization/KSerializer;Lkotlinx/serialization/KSerializer;)V
    ...
    invoke-direct {v4, v7, v8, v15}, Lkotlinx/serialization/ContextualSerializer;-><init>(Lkotlin/reflect/KClass;Lkotlinx/serialization/KSerializer;[Lkotlinx/serialization/KSerializer;)V
    ...
    invoke-direct/range {v4 .. v11}, Lcom/vungle/ads/internal/model/AdPayload;-><init>(ILjava/util/List;Lcom/vungle/ads/internal/model/ConfigPayload;Ljava/util/concurrent/ConcurrentHashMap;Ljava/util/Map;ZLkotlinx/serialization/internal/SerializationConstructorMarker;)V
